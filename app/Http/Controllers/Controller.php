...
class Controller extends BaseController
{
    ...
    {
        return view('includes.changepassword')->with(array('title' => 'Change Password',));
    }
    ...
    public function autotopup()
    {
        ...
        foreach ($plans as $plan) {
            ...
            //get settings
            $trade_mode = Setting::getValue('trade_mode');
            ...
            if ($trade_mode == 'on') {
                ...
                if ($condition) {
                    ...
                    if ($weekend_trade == 'true') {
                        if ($plan->last_growth <= $togrow) {
                            ...
                            $objDemo->received_amount = "$currency$increment";
                            $objDemo->sender = $site_name;
                ...
                if ($condition2) {
                    ...
                    $objDemo->receiver_email = $user->email;
                    $objDemo->receiver_plan = $dplan->name;
                    $objDemo->received_amount = "$currency$plan->amount";
                    $objDemo->sender = $site_name;
                    $objDemo->receiver_name = $user->name;
                    $objDemo->date = \Carbon\Carbon::Now();
