        ...
        const e = location.pathname.slice(location.pathname.lastIndexOf("/") + 1),
            ...
            r = {
                ...
                addActiveParent: function (e) {
                    e.forEach(e => { null !== e.querySelector("." + t.activeClass) && e.parentElement.classList.add(t.activeClass) })
                },
                init: function () {
