...
return [
    ...
    'webtrader' => [
        'webtrader_title1' => 'AxePro Webtrader',
        'webtrader_title2' => 'Trading Platform',
        'webtrader_platform' => '  Our WebTrader platform is fast becoming one of the most popular used by traders, providing an added level of market analysis and access to full market depth on an impressive and fully customisable user interface. Alongside AxePro’s advanced trading infrastructure, competitive pricing and superior order execution with no dealing desk intervention*, our WebTrader provides one of the most innovative trading experiences in the industry.',
        ...
        'mt5_account' => 'Access your MT5 account
    ...
    'metatrader' => [
        ...
        'fx_mt5' => 'Carrying on its predecessor’s impressive reputation, the FxPro MT5 trading platform provides you with everything you need to trade the financial markets. MT5 is easy to use and fully customisable to suit your trading style, with an advanced environment for EA development and additional features.',
        'btn_3' => 'Start Trading Now',
        'metatrader_five' => 'Metatrader 5',
        'desktop_platform' => 'Desktop Platform',
        'ea_trading' => 'The MT5 is becoming one of the most widely used platforms in the industry, incorporating all of the key features that have been championed for years with the MT4, but with some additional features and an optimised environment for EA trading.',
        ...
        'download' => 'Download for free to take advantage of all the benefits it has to offer in conjunction with the FxPro MT5 Trading account',
        'for_win' => 'Download MT5 for Windows',
        'for_mac' => 'Download MT5 for Mac',
        ...
        'netting' => 'The FxPro MT5 account is set to ‘Netting’ as default, meaning that trades are aggregated, and hedging is not possible',
        'hedging' => 'although we can provide a ‘hedging’ version of the platform on request',
        'meta_for_mobile' => 'MetaTrader 5 for Mobile & Tablets',
        'with_fxpro' => 'With FxPro MT5 Mobile you can enjoy the most popular trading platform on your mobile phone, anywhere at any time. Available for iOS and Android',
    ...
    'about' => [
        ...
        'aim' => 'At AxePro Group we evolve with the times. We aim to continuously refine our services to cater to the needs of traders in this highly dynamic industry',
    ...
    'security' => [
        ...
        'safety' => 'At AxePro, the safety of client data is a priority and we have sophisticated security measures in place designed to protect your personal information, privacy and funds',
        ...
        'control' => 'We take all controls to maintain the FxPro Direct portal as a safe place for executing your transactions',
        ...
        'disclose_pt2' => 'AxePro and other reputable companies would never ask for such details and you should deem any such contact or requests to be suspicious',
        ...
        'for_clarity' => 'For clarity, we would like to highlight that AxePro',
        ...
        'fraud_pt2' => 'If you receive any unsolicited calls, emails or SMS claiming to be AxePro, do not engage in any communication and report this to us immediately via our official communication channels on our website',
        ...
        'we_remind_you_pt2' => 'The official FxPro mobile application is available to download only from the Apple App Store and Google Play store. Other official trading software provided by us can be found in our download centre',
    ...
    'trading_platforms' => [
        ...
        'more_features' => 'Enjoy more features with AxePro’ MT5 trading platform. The AxePro MT5 is the latest and most advanced MetaTrader platform that offers all the pioneering features of MT4, with the addition of more advanced trading tools and indicators that enable traders to maintain more control of their trades and make more informed decisions using cutting-edge analysis',
        'benefits' => 'Advantages & Benefits',
        'lates_platform' => 'The latest MetaTrader platform provides a number of additional analytical tools and functions designed to give you a more comprehensive trading arsenal and an improved experience, thus making it one of the best platforms available in the market.',
        'mobile_apps' => 'AxePro Mobile Apps',
    ...
    'privacy_policy' => [
        ...
        'b1' => 'AxePro is always looking to improve the experience of our clients in more ways than one and in
        an effort to create and manage every trading account our clients have, the company will need to
        access some necessary information from them. The Policy on Privacy Protection indicates how AxePro
        ...
        'security' => 'Security',
        'cookies' => 'Cookies on AxeProgroup.com',
        ...
        'links' => 'Links',
        'b13' => 'Our website, AxeProgroup.com, may contain links to other websites on the internet. We are not, in
...
beneficial than original value which could perhaps be obtainable in a different occurrence. ',
    ...
    'terms_service' => [
        ...
        herein. This document, which is a legal contract between the client and AxePro (“AxePro ,” “Company,” “we,” “us,” “our”), shall determine the responsibilities and rights of AxePro and its clients in connection with the Company’s services.',
        ...
        capable of managing transactions on a regular basis. AxePro has provided a Declaration
        ...
        'b5' => 'AxePro powered by AxePro Ltd. (Registration No. 936729). A Company with
    ...
    'headings' => [
        'head' => 'HEADINGS',
        'b1' => '“AxePro ” refers to the Company, affiliates, subordinates, and their beneficiaries;',
    ...
    'application' => [
        ...
        obligations and rights set at the time that the Client started to trade using AxePro
    ...
    'eligibility' => [
        ...
        services AxePro provides are intended only for clients who are not prohibited by
    ...
    'offerings' => [
        ...
        'b1' => "AxePro offers a variety of trading Services to clients and these include
    ...
    'funding' => [
        ...
        to the withdrawal. It is the exclusive right of AxePro to reject any other withdrawal
    ...
    'client_fund' => [
        'head' => 'CLIENT FUND ',
        'b1' => "AxePro shall be allowed to keep the client's funds for the use of trading. Losses
    ...
    'fund_transfer' => [
        ...
        account, the Client affirms that such action is performed under his/her own risk, as AxePro cannot be held liable for your action and is not obliged to make any
        ...
        should submit a formal request subject to approval. AxePro may dismiss funds
        transfer requests. ',
    ...
    'responsibility' => [
        ...
        'b7' => 'All conversations between the Client and AxePro workforces may be electronically
        ...
        recordings are sole properties of the Company; AxePro therefore reserves the
    ...
    'bonus' => [
        ...
        the required trading volume determined by AxePro is met (minimum trading
        ...
        the trading account of the Client. AxePro also reserves the right to block the
        Client's trading account and return the balance to the Client.",

    ],
    'seclusion' => [
        'head' => 'SECLUSION OF CLIENT FUNDS AND CURRENCY CONVERSIONS   ',
        'b1' => "AxePro shall conduct money it holds on the Client's behalf as clients' funds. The
        ...
        'b2' => "AxePro coordinates with various credit institutions; a complete list of these
    ...
    'fees' => [
        ...
        'b1' => "Clients may be required to pay the cost and charges outlined in AxePro's Service
        ...
        that instituted the professional connection between the Axepro workforces and
        the clients.  ",
    ...
    'margin' => [
        ...
        changed at any time. AxePro may impose maximum requirements to comply with
        ...
        account and margin level, while AxePro may elect to limit the trades and
    ...
    'abritage' => [
        ...
        'b1' => "AxePro strictly prohibits any form of arbitrage and manipulation of its platform,
    ...
    'derivatives_policy' => [
        ...
        matter. AxePro can execute orders of the client, but is not obliged to do so,
    ...
    'investment_advice' => [
        ...
        'b1' => "Based on what the Company considers reliable, AxePro and all its workforces
    ...
    'disputes' => [
        ...
        have had with respect to AxePro regarding such discrepancy since the impossibility
        ...
        regardless of further impact of profit or loss from the total amount of profit and loss. Noncompliance with these actions is seen as an inability to mitigate losses. The Client must submit any complaints to AxePro in writing to the email address:
        support@AxePro.com. ',
        'b4' => 'Within thirty (30) business days, AxePro must verify any written
        ...
        agrees to pay AxePro reputational damages of $100.00 per day from the time of
        such violation, while the cumulative maximum of the payment may reach $10,000.00.',
        'b6' => 'The Client and AxePro undertake to make every effort to resolve any dispute, in good
        faith and on a constructive basis. The Client acknowledges and agrees that threats and/or
        blackmail against AxePro is/are prohibited and is/are the legitimate ground/s for the
        termination of negotiations and the immediate termination of any business relationship.',
        'b7' => 'Without prejudice to any other AxePro rights under these Terms, if the parties are in
        dispute regarding a trade warrant, AxePro has the right in its sole discretion and
        without prior notice to accept any opinion and actions that it considers reasonable to limit
        the maximum amount involved in the dispute. AxePro is not liable to the Customer,
    ...
    'indemnification' => [
        ...
        'b1' => "You acknowledge that AxePro and its workforces shall not be held liable for any
        losses, costs, expenses and damages that may arise in case the Client fails to
        accomplish his/her obligations in this Agreement. AxePro is free of liability in all
        claims that may have been contributed by system and/or equipment error of AxePro
    ...
    'confidential' => [
        ...
        property rights are exclusive property of AxePro and its licensors. All of these and
    ...
    'termination' => [
        ...
        positions; and that no amount is owed by the Client to AxePro . The Client may
        ...
        towards the Company, AxePro reserves the right to call back all profits
        generated from the Company's services. AxePro has the sole and exclusive
    ...
    'body' => [
        ...
        'open' => 'OPEN ADDITIONAL ACCOUNTS',
        'downloads' => 'DOWNLOADS',
        'deposited' => 'Deposited',
        'balance' => 'Balance',
        'bonus' => 'Bonus',
        'personal_chart' => 'Personal Trading Chart',
        ...
        'metatrader' => 'Download MetaTradre 5 For PC , smartphones, and tablets',
