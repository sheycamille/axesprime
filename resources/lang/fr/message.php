...
return [
    ...
    'home' => [
        ...
        'button_1' => "S’inscrire en 60 S",
        'subtitle' => "Trader les devises, les matières premières, les indices synthétiques et les indices boursiers à partir d'un seul compte",
    ...
    'app' => [
        ...
        'logout' => 'Déconnexion',
        'home' => 'Accueil',
        'axepro_group' => 'Groupe AxePro 2022.',
        'powered' => 'Réalisé par le groupe AxePro.',



    ],
    'fx_calc' => 'Calculatrice FX tout-en-un',
    ...
    'shares' => [
        'shares_stocks' => "Négociation d'actions et de titres",
        'trade_on_shares' => "Négociez des CFD sur des milliers d'actions mondiales et bénéficiez d'une exécution ultra-rapide des ordres et de conditions de négociation compétitives. Négociez des CFD sur les actions de certaines des sociétés les plus importantes et les plus populaires aux États-Unis, au Royaume-Uni et dans l'Union européenne.",
        'most_popular_shares' => 'Les actions les plus populaires sont celles qui combinent les actions de certaines des plus grandes entreprises reconnues mondialement.',
    ...
    'contact' => [
        ...
        'france_office' => 'Nos bureaux en France',

    ],
    'about' => [
        'about_pt1' => 'À propos du groupe',
        'about_pt2' => 'Axepro',
        'fsa' => "Le Groupe AxePro est autorisé par la FSA de SVG en 2021 à agir en tant qu'intermédiaire financier et monétaire dans la conduite d'activités de courtage financier et monétaire pour la vente et l'achat de devises et l'intermédiation dans des opérations de marquage de l'argent et comme autorisé avec le numéro de société 678 SVG.t",
    ...
    'six_years' => '6 ans',
    'fifthteen' => '15 ans',
    'regulated' => 'Réglementé au Royaume-Uni',
    'cus_support' => 'Soutien aux clients',
    'five_years' => "Plus de 5 ans d'excellence",
    'global_broker' => 'Un courtier véritablement mondial',
    'growth' => "AxePro a connu une croissance exponentielle au fil des ans et est devenu réputé pour fournir des conditions de trading d'élite à ses clients.
    ...
    'our_work' => 'Notre travail a été reconnu à plusieurs reprises par le secteur, avec plus de 90 récompenses reçues à ce jour pour la qualité de nos plateformes et de nos services.',
    ...
    'calc' => 'Calculatrice',
    'company' => 'Entreprise',
    'abt' => "À propos d'AxePro",
    'cdt' => 'Score de Crédit',
    'sec' => 'Sécurité',
    'ctc' => 'Contactez Nous',
    'crt_acnt' => 'Créer un compte',
    'log' => 'Connexion',
    'excellence' => "5 ans d'excellence",
    'gbl_awd' => 'Plus de 15 prix internationaux',
    'cus_sup' => 'Assistance clientèle 24/6',
    'copyright' => 'Copyright ©2022 AxePro Group. Tous droits réservés',
    ...
    'industry_regulations' => "4 Réglementation",
    'clients' => "1k+ clients",
    'econs_earnings' => "Calendriers économiques et des gains",
    'frx_nws_page' => "Nouvelles du marché",
    ...
    'dashboard' => [
        ...
        'notif' => 'Notifications',
        'trade' => "Comptes d'opérations",
        'live' => 'Comptes en direct',
        'demo' => 'Comptes de démonstration',
        'trans' => 'Historique des transactions',
        'deposits' => 'Dépôt/retrait',
        'depo' => 'Dépôts',
    ...
    'topmenu' => [
        ...
        'refresh' => 'Rafraîchir',
        'hi' => 'Bonjour',
        'chg_pss' => 'Changer le mot de passe',
    ...
    'privacy_policy' => [
        ...
        'b1' => "AxePro cherche toujours à améliorer l'expérience de ses clients à plus d'un titre et, dans un effort pour créer et gérer tous les comptes de trading de ses clients, la société aura besoin d'un système de gestion des comptes.
        et dans un effort pour créer et gérer chaque compte de trading de nos clients, la société devra avoir
        d'accéder à certaines informations nécessaires. La politique de protection de la vie privée indique comment AxePro
        ...
        'b2' => "Dans le cadre (a) de la création ou de l'ouverture d'un compte ; (b) du dépôt et du retrait de fonds, la Société
        a le droit de recueillir des informations pour authentifier votre identité et vous contacter par le biais des moyens suivants :",
        'list1' => 'Adresse',
        'list2' => 'Numéro de Pnone',
        'list3' => 'Courriel :',
        'b3' => "Ces informations seront ou pourront également être collectées ultérieurement auprès de vous, directement ou indirectement.
        Certaines des informations susceptibles d'être collectées sont les suivantes : adresse de protocole Internet,
        système d'exploitation, identifiant Mac, fournisseur d'accès à Internet, type de navigateur et cookies. ",
        'b4' => "Afin d'accomplir pleinement les exigences réglementaires, l'entreprise aura le droit de demander plusieurs informations identifiables telles que le passeport, le permis de conduire et plusieurs autres documents qui peuvent être utilisés par le client.
        plusieurs informations identifiables telles que : passeport, permis de conduire et plusieurs autres documents qui peuvent justifier votre document.
        peuvent justifier votre document. ",
        'revising' => 'Révision des informations personnelles',
        'b5' => "En outre, la Société doit, par tous les moyens, s'assurer que toutes les informations sont actuelles, correctes et mises à jour à tout moment. Dans tous les cas, vous devez informer la Société de tout changement soudain ou de toute inexactitude dans vos informations personnelles. La Société enquêtera alors sur la question et corrigera toute erreur afin de maintenir l'exactitude.",
        'usage' => "Utilisation de l'information",
        'b6' => "La Société collecte des informations pour l'amélioration et le perfectionnement de notre service actuel offert,
        et pour garantir que vous êtes pleinement informé et conscient, et que vous avez accepté que la société ait le droit d'utiliser les informations données pour vous contacter.
        le droit d'utiliser les informations fournies pour vous contacter.",
        'b7' => "La Société ne sera pas autorisée et n'aura pas le pouvoir de partager vos informations personnelles à
        tout tiers affilié ou non affilié autre que de la manière des entités énumérées ci-dessous :",
        'b8' => "Aux prestataires de services, dans le but de créer ou d'ouvrir un compte, et de fournir votre
        ...
        'security' => 'Sécurité',
        'cookies' => 'Cookies sur AxeProgroup.com',
        ...
        Société, toutes les informations non désirées ou inutiles sont immédiatement détruites.",
        'b11' => "Notre site web utilise des cookies afin d'améliorer la navigation des utilisateurs et la fonctionnalité du site. Les cookies, sous
        sous quelque forme que ce soit, ne contiennent aucune information permettant d'identifier une personne. En outre, les cookies sont utilisés comme
        suivants : ",
        'list4' => 'Identifier votre identité',
        'list5' => "vous authentifier en tant qu'utilisateur sur notre site web",
        'list6' => 'Améliorer la navigation des utilisateurs',
        'list7' => "Facilité d'accès sur notre site web",
        'list8' => "Vous pouvez supprimer manuellement les cookies dans votre navigateur, mais le blocage ou la suppression des cookies vous empêchera de consulter et d'utiliser les fonctions de notre site Web et de notre plateforme de négociation.
        de visualiser et d'utiliser les fonctionnalités de notre site web et de notre plateforme de négociation.",
        'update' => 'Mise à jour des politiques',
        'b12' => "La société se réserve le droit d'amender, de réviser, de modifier et/ou de changer cette politique chaque fois qu'elle le juge approprié.
        ...
        'links' => 'Liens',
        'b13' => "Notre site web, AxeProgroup.com, peut contenir des liens vers d'autres sites web sur l'internet. Nous ne sommes, en
        ...
        'questions' => 'Questions',
        'b14' => 'Si vous avez des questions concernant les points suivants :',
        'pol' => 'Policy',
        'changes' => 'Modifications de vos informations personnelles',
        'access' => 'Accès à vos informations personnelles',
        'b15' => "Veuillez contacter le département de conformité en indiquant votre nom, votre numéro de contact avec l'indicatif régional,
        adresse électronique et adresse postale.",
    ],
    'order_execution' => [
        ...
        le processus d'approvisionnement en fournissant le meilleur résultat possible à ses clients, tout en permettant à AxePro d'exécuter les commandes de ses clients.
        AxePro exécute les commandes de ses clients.",
        ...
        AxePro sera toujours la contrepartie principale au fur et à mesure de l'exécution des ordres des clients.
        exécutés.",
        'b4' => "De plus, AxePro ne peut pas garantir qu'une fois la commande donnée, les dépenses du client seront
        sera
    bénéfique que la valeur originale qui pourrait peut-être être obtenue dans un autre cas. ",
        'exe' => "Aspects de l'exécution",
        'b5' => 'AxePro est tenu de prendre en compte plusieurs aspects dans sa délibération ; les suivants sont détaillés
        ci-dessous :',
        'b6' => "De plus, AxePro ne peut pas garantir qu'une fois la commande donnée, les dépenses du client seront
        sera
        bénéfique que la valeur originale qui pourrait peut-être être obtenue dans un autre cas.",
        'quotes' => ' Citations',
        'b7' => "AxePro crée une valeur négociable propre à partir des chiffres obtenus sur les sources de prix libérées.
        sources de prix, en comptant les banques qui offrent principalement la liqueur à travers le marché mondial.
        AxePro garantit que les contrôles de l'écart entre l'offre et la demande sont complétés par la recommandation d'un vaste assortiment de sources de prix fondamentales, en comptant les banques qui offrent principalement la liquéfaction à travers le marché mondial.
        recommandation à un assortiment étendu de sources de prix fondamentaux, en comptant les bases statistiques.
        bases statistiques. Ainsi, AxePro peut garantir que le client reçoit la meilleure exécution possible. ",
        'charges' => ' Charges',
        ...
        ",
        'all' => ' Commandes de toutes tailles',
        ...
        circonstances, car la liquidité augmente sur le marché. AxePro se réserve le droit de refuser
        l'ordre d'un client, si la taille de l'ordre est considérée comme trop importante et ne peut être exécutée par AxePro. ",
        'frequency' => 'Fréquence',
        'b10' => "Normalement, les valeurs des prix changent souvent dans les périodes à venir. La régularité avec laquelle ils le font
        varie selon les instruments financiers et les conditions actuelles du marché. Comme AxePro
        produit ses propres valeurs de prix négociables, la technologie utilisée par le client pour établir des relations avec AxePro jouera un rôle déterminant.
        relations avec AxePro jouera un rôle déterminant. En outre, les prix négociables
        sont distribués par le biais des programmes de négociation d'AxePro.",
        'instruments' => 'Instruments',
        'b11' => 'AxePro exécute les ordres relatifs à tout instrument de négociation de produits dérivés sur devises (" FX ").',
        'b12' => 'AxePro propose les produits de change suivants
        produits :',
        ...
        'l6' => "Lors de l'exécution d'une commande d'un client, AxePro est autorisé à mettre en place les éléments suivants
        ...
        'b13' => "Dans le cas où le Client reçoit une directive précise de la part d'AxePro concernant l'exécution de la commande et que la société a décidé de cette directive, l'exécution de la commande ne sera pas possible.
        ...
        'b14' => "Néanmoins, si le client souhaite exécuter un ordre et donne une certaine instruction, alors en exécutant cet ordre, AxePro s'acquittera de la responsabilité d'Axes Prime de fournir la meilleure exécution.
        l'ordre, AxePro s'acquittera de la responsabilité d'Axes Prime de fournir la meilleure exécution au client.
        pour le client. Cela peut avoir pour conséquence de ne pas être qualifié pour se conformer à la politique d'exécution des ordres d'AxePro pour cet ordre.
        d'exécution des ordres d'AxePro pour cet ordre précis.
        ",
        ...
        'b16' => "En général, les fonds placés sur les comptes des clients auprès d'Axes Prime, en comptant les ordres qui sont positionnés vers une plateforme de trading, sont sécurisés par AxePro.
        ...
        'b21' => "La politique mise en œuvre par AxePro sera certainement surveillée, y compris les dispositions substantielles relatives à l'exécution des ordres.
        ...
        'b17' => "Il est également obligatoire pour l'entreprise d'évaluer systématiquement la Politique et les préparatifs d'exécution de la commande en question, afin de mesurer si AxePro est compétent en la matière.
        d'exécution des ordres sur une base systématique dans tous les cas afin de mesurer si AxePro est suffisamment
        suffisamment compétent pour fournir la meilleure exécution à ses clients. ",
        'permissions' => 'Permissions des clients',
        'b18' => "AxePro est tenu d'obtenir l'accord préalable du client sur cette politique lorsqu'il établit une association commerciale avec le client.
        d'affaires concernant le Client. De plus, AxePro est tenu d'obtenir l'accord préalable du
        ...
        'b19' => "AxePro est capable d'acquérir les accords susmentionnés dans le cadre d'un règlement général.",
        'b20' => "AxePro s'adaptera aux Clients qui ont acquis la Police ou qui ont été sanctionnés pour la prendre par
        moyens électroniques ou toute autre transaction en ligne, y compris ceux qui se sont largement mis d'accord
        sur les conditions générales de vente d'AxePro. ",
        'contact' => 'Contact',
        'cus' => 'Département du support client',
        'email' => 'Courriel :support@AxePro.com ',

    ],
    'risk_disclosure' => [
        'risk' => 'Politique de divulgation des risques',
        'declaration' => 'Déclaration des risques',
        'b1' => "Cette divulgation des risques est fournie par la société en tant qu'instruction écrite des avertissements impliqués dans la conclusion du contrat.
            l'Accord, qui couvre tous les risques liés à la négociation de l'Instrument Financier et d'autres risques subséquents liés au respect de l'Accord.
            risques ultérieurs liés à l'exécution de l'accord. Il est conseillé à tous les clients d'obtenir
            l'assistance d'un conseiller financier tiers s'il ne comprend pas le contenu et/ou les risques de ce contrat.
            risques impliqués dans cet accord. Le Client comprend et accepte les risques énumérés ci-dessous, mais sans s'y limiter
            pas limités : ",
        'sect1' => 'Section 1. Négociation conventionnelle',
        'b2' => "La société suggère qu'aucun membre ne devrait signer l'accord sans être informé des risques substantiels.
            informés des risques substantiels. La valeur des titres du client est exposée à différents risques de marché, tels que les conditions économiques, les taux d'intérêt, les bénéfices, les taux de croissance et autres perceptions du marché.
            tels que les conditions économiques, les taux d'intérêt, les bénéfices, les taux de croissance et autres perceptions du marché.
            impliquer.",
        'b3' => "Le client est responsable du suivi de ses positions ouvertes à tout moment. Il est également
            responsable d'être capable de faire face aux pertes potentielles qui peuvent être encourues lors de ses transactions. La société
            Société peut choisir de créer des évaluations générales du marché dans d'autres cas.",
        'sect2' => 'Section 2. Défaut',
        'b4' => "Les positions du Client peuvent être fermées par la Société sans aucune notification si le client est trouvé
            d'une quelconque insolvabilité. Dans ce cas, le client est tenu de transférer la pleine propriété et le titre d'une partie spécifique de l'argent déposé à la société.
            partie spécifique de l'argent qui a été déposé à la société.",
        'b5' => "L'argent requis par le client assurera ses engagements actuels, ou futurs et réels envers la société.
            y compris les exigences de marge. La société émettra alors le montant nécessaire en fonction des
            les positions ouvertes et les transactions quotidiennes du trader. Le client reconnaît et comprend donc la possibilité que le montant soit augmenté en raison de l'évolution de la situation.
            que le montant soit fixé plus haut en raison de la marge requise indiquée.",
        'b6' => "Le montant ne fera pas l'objet d'un recouvrement si l'entreprise se trouve dans l'incapacité de payer le client à temps.
            capable de payer le client à temps. ",
        'sect3' => 'Section 3. Système électronique',
        'b7' => "Le client est informé des risques suivants incriminés dans l'utilisation du système électronique, et des éventuelles
            pertes financières qui peuvent avoir lieu tout au long du processus possible.",
        'b8' => "Il arrive qu'il y ait des défaillances de connexion et que le logiciel ne fonctionne pas correctement. La société
            Société ne sera pas responsable des dommages ou pertes subis par le Client en cas d'impossibilité d'accéder aux systèmes électroniques de la Société et si les ordres ne sont pas exécutés en raison d'un problème électronique.
            d'accéder aux systèmes électroniques de la Société et si les ordres ne sont pas exécutés en raison de dysfonctionnements des
            dysfonctionnements du système électronique.",
        'b9' => "Pendant le processus de négociation, des problèmes tels qu'un dysfonctionnement de l'Internet peuvent survenir. Le client,
            Le client sera alors exposé à diverses défaillances du réseau qui peuvent affecter ses transactions en ligne avec la société et, par conséquent, empêcher l'exécution des ordres.
            transactions en ligne avec la société et donc interférer avec l'exécution des ordres.",
        'b10' => "La Société ne sera pas tenue responsable de l'échec de l'exécution de l'ordre lié à la panne du
            du système électronique. Le Client accepte et comprend que la Société n'est pas responsable de toute
            réclamations, dépenses, dommages ou pertes et coûts résultant d'un mauvais fonctionnement ou d'une panne de tout système de
            système de communication et du logiciel de trading appartenant à la Société.",
        'b11' => 'Les systèmes, les installations et les programmes de la société sont tous susceptibles de subir des pannes ou des interruptions transitoires
            en raison des limitations des connexions Internet.',
        'b12' => "Toutes les formes de danger ou de perte causées par l'accès illégal d'un tiers ou le laxisme du Client ne sont pas opposables à la Société.
            contre la Société.",
        'sect4' => 'Section 4. Relations de négociation et de fixation des prix ',
        'b13' => "Lorsqu'un client prend une position sur l'un des instruments financiers proposés, celle-ci contient certainement une commission ou un paiement financier.
            contenir une commission ou un paiement de financement.",
        'sub1' => 'Commandes de toutes tailles',
        'b14' => "Des conditions de marché spécifiques et/ou des opérations ou des événements des acteurs du marché se déroulant pendant les
            opérations de trading peuvent renforcer l'exposition aux pertes par l'impossibilité d'exécuter la transaction et/ou de liquider la position de compensation du client.
            et/ou la liquidation de la position de compensation du Client. Les règles du marché peuvent également affecter le déroulement de la transaction et conduire à des situations inévitables.
            transaction et peuvent conduire à des risques inévitables",
        'b15' => 'Le flux des transactions peut changer en raison de conditions de marché anormales.
            dans les circonstances mentionnées entraîneront un retard dans le processus et des changements dans les prix.',
        'b16' => "Le client comprend la perte impliquée dans les cas de circonstances inévitables où la société ne sera pas responsable des dommages ou de la perte d'événements indépendants de sa volonté.
            ne sera pas responsable des dommages ou des pertes causés par des événements indépendants de sa volonté.",
        'sect5' => 'Section 5. Produits dérivés en général',
        'b17' => 'Le client doit être conscient que les transactions liées aux produits dérivés sont identiques aux investissements dans des
            contrats à terme. En outre, les transactions sur produits dérivés peuvent entraîner des responsabilités et/ou des obligations inattendues auxquelles le client doit être réceptif.
            auxquelles le client doit être réceptif.',
        'b18' => 'Le client ne détient pas le droit exclusif sur un instrument sous-jacent, y compris les actions de référence,
            les droits de vote, et/ou toute autre information liée et incluse. La société ne sera pas non plus
            obligée de révéler toute information non pertinente induisant les risques qui sont incorporés dans la dépense.
            Dérivés.',
        'b19' => "Les produits dérivés sont recommandés aux traders qui ont une connaissance suffisante des risques liés aux transactions légales et économiques.
            et économiques. Les clients qui acceptent d'acheter un instrument financier dérivé comprennent le risque de perdre de l'argent et parfois la totalité de leur investissement.
            risque de perdre de l'argent et, dans certains cas, tout ce qu'il a investi.",
        'b20' => "Des pertes et des gains importants peuvent résulter de l'effet de levier des produits dérivés ; le changement de mouvement peut être bénéfique pour le
            client. Toutefois, dans certains cas, il peut s'agir d'un inconvénient. Dans le cadre du trading, les produits dérivés impliquent de placer une transaction fixée par
            la Société en fonction de l'évolution des prix. Les prix sont modifiés de temps en temps
            en fonction des circonstances, telles que les scénarios nationaux et économiques du monde entier.
            Seuls les actifs sous-jacents proposés par la société sont autorisés à faire l'objet de transactions sur les produits dérivés et
            doivent être traitées uniquement sur le système de négociation de l'entreprise.",
        'sect6' => 'Section 6. Révocation de la négociation',
        'b21' => "Si les prix changent soudainement sur le marché, il serait impossible dans certains cas de liquider une position, car le prix de l'actif sous-jacent pourrait augmenter ou diminuer soudainement.
            position car le prix de l'actif sous-jacent pourrait soudainement augmenter ou diminuer. Dans certaines circonstances
            le prix peut monter et descendre en une seule transaction, ce qui entraînera la suspension ou la restriction de l'actif sous-jacent.
            sous-jacents. Le client comprend que, dans ces conditions, il doit accepter les risques corrélés et qu'il est responsable de la gestion des risques.
            risques corrélés et qu'il est responsable des pertes éventuelles.",
        'b22' => "La Société détient le droit exclusif d'annuler ou de fermer une position dans lesdites circonstances et à la suite de
            de la transposition des informations. Dans ce cas, la Société n'aura aucune responsabilité spécifique pour les dommages ou pertes qui pourraient survenir.
            dommages ou pertes qui pourraient survenir.",
        'sect7' => 'Section 7. Accès non autorisé',
        'b23' => "La société ne sera pas responsable de la perte qui pourrait survenir en raison d'une mauvaise communication du client. A
            tiers peut agir en tant que canal de livraison de l'argent ou des fonds du Client à la Société et, dans certains cas, peut les accepter temporairement pour effectuer une transaction.",
        'b24' => "S'il s'avère que la tierce partie effectue des activités frauduleuses avant, pendant et après la
            et après la transaction, la société ne sera pas tenue responsable des dommages ou des pertes qui peuvent survenir.
            survenir. Le Client accepte et comprend tous les risques liés au fait de permettre à une tierce partie d'effectuer des transactions en son nom, tels que l'accès non autorisé au système de trading.
            en son nom, tels que l'accès non autorisé à la plateforme de trading. En outre, le client doit
            conserver toutes ses informations de connexion de manière sûre et sécurisée. ",
        'sect8' => 'Section 8. Autres risques',
        'b25' => "La Société ne garantit pas que le succès de l'investissement d'un Trader soit le même que celui de l'autre.
            et la stratégie d'investissement de chaque trader peut différer ou dépendre de ce qui convient au client.",
        'b26' => "La société fonctionne avec les protections de sécurité les plus avancées. Toutefois, le site Web peut
            être vulnérable à d'autres menaces de cyber-sécurité qui seront hors de son contrôle. Le client peut alors
            peut être confronté à des erreurs de système, des défaillances techniques, des blocages malveillants de l'accès et d'autres
            interruptions d'Internet. Dans ce cas, la Société ne sera pas responsable de l'altération ou de la falsification des données du client.
            falsification des informations personnelles du Client ou de toute perte sur le compte personnel du Client.
            le Client. ",
        'b27' => "Dans tous les cas où le client décide d'effectuer des opérations sur marge, il doit comprendre les risques qu'elles comportent, tels que la perte de fonds supérieure au montant déposé et la vulnérabilité de l'entreprise.
            inclus tels que la perte de fonds supérieure au montant déposé et la vulnérabilité du prix du marché de l'investissement dans le mouvement ou les changements du marché.
            prix de marché de l'investissement dans le mouvement ou les changements du marché.",
        'b28' => "Le client doit comprendre que la négociation de transactions financières de gré à gré peut augmenter et accroître le risque de perte par rapport à d'autres marchés réglementés.
            et augmenter le risque de perte par rapport aux autres marchés réglementés. Ceci est dû à l'indisponibilité du
            marché pour fermer les positions ouvertes, des prix et d'autres circonstances qui doivent être soumises à des
            conditions et/ou modalités légales. Ce type de transaction peut accroître les risques de liquidité et peut entraîner l'impossibilité d'accéder à la valeur de la position.
            de liquidité et peut entraîner l'impossibilité d'accéder à la valeur d'une position liée à une transaction hors marché. ",
        'b29' => "La Société informera le Client que la plateforme de trading en ligne de la Société n'est pas accessible pendant les week-ends.
            pendant les week-ends, il existe donc un risque potentiel que les ordres stop-loss soient traités au pire prix par rapport au prix spécifié avant la fermeture du vendredi.
            traités au plus mauvais prix par rapport au prix spécifié avant sa fermeture le vendredi. Le site
            Client comprend qu'il peut y avoir des événements soudains ou discrets sur le marché qui peuvent se produire pendant les week-ends.
            Le client comprend que des événements soudains ou discrets peuvent se produire sur le marché pendant les week-ends, et que le prix spécifié est donc susceptible de changer.",
        'b30' => "Le client doit être conscient et informé des responsabilités et des coûts liés à l'acquisition d'une position dans la société.
            Société et doit obtenir tous les détails nécessaires sur les frais, charges ou commissions dont il pourrait être
            commissions dont il pourrait être responsable.",
        'b31' => "Tous les investissements libellés en devises étrangères sont exposés aux fluctuations des taux de change
            et des frais de conversion des devises, ainsi, tout changement du taux de la devise affectera la
            l'état financier du client.",
        'b32' => "La Société informe le Client que la plateforme de trading en ligne de la Société n'est pas accessible pendant les week-ends.
            pendant les week-ends, et qu'il existe donc un risque important que les ordres stop-loss soient traités au pire prix par rapport au prix spécifié avant sa fermeture le vendredi.
            traités au plus mauvais prix par rapport au prix spécifié avant sa fermeture le vendredi. Le client
            comprend qu'il peut y avoir des événements discrets sur le marché qui peuvent se produire pendant les week-ends ;
            Par conséquent, le prix spécifié est susceptible de changer. ",
        'b33' => "Le client doit être conscient des responsabilités et des coûts liés à l'acquisition et au placement d'une position dans la société.
            Société et doit se procurer tous les détails nécessaires sur les frais, charges ou commissions qu'il/elle
            pourrait être responsable",
        'b34' => "Nos conditions générales stipulent que le client peut acheter un remboursement UNIQUEMENT s'il y a une marge disponible sur le solde du client.
            disponible sur le solde du client.",
        'b35' => "Lorsque la société reçoit une instruction du client de rembourser des fonds de son compte, une demande formelle doit être soumise par le client afin d'être initiée par la société.
            formelle sera alors soumise par le client afin d'être initiée par la société. ",
        'b36' => 'La Société procédera au remboursement dans un délai de deux Jours ouvrables sur le même mode de paiement que celui par lequel les
            les fonds ont été reçus, si les conditions suivantes sont remplies :',
        'b37' => "A. l'instruction de remboursement comprend toutes les informations nécessaires ;",
        'b38' => "B. l'instruction est d'effectuer un virement bancaire de fonds sur le compte du client, dans le cas où
            nécessaire ;",
        'b39' => "C. le client n'a pas de transactions ouvertes sur son compte, ou après divulgation des risques, le remboursement ne met pas
            le compte de négociation du client ne risque pas de perdre la marge libre ;",
        'b40' => "au moment du paiement, la marge libre du client dépasse le montant spécifié dans l'instruction de retrait, y compris tous les frais de paiement.
            instruction de retrait, y compris tous les frais de paiement.",

    ],

    'terms_service' => [

        'terms' => "Conditions d'utilisation des services",
        ...
        'b1' => "Le client (le ' client ') affirme qu'en utilisant nos services, il ou elle
                ...
                dans le présent document. Ce document, qui constitue un contrat légal entre le client et AxePro ('AxePro', 'Société', 'nous', 'notre'), détermine les responsabilités et les droits d'AxePro et de ses clients dans le cadre des services de la Société.",
        ...
        'b3' => 'Les produits dérivés et/ou les opérations sur devises comportent un risque élevé de perte et ne conviennent pas à tout le monde. Ces
                ...
                capable de gérer des transactions sur une base régulière. AxePro a fourni une déclaration de
        ...
        'b5' => "AxePro powered by AxePro Ltd. (numéro d'enregistrement 936729). Une société avec
        ...
        'b6' => "Toutes les plaintes peuvent être adressées à l'adresse électronique et/ou au numéro de téléphone.
                et seront résolues conformément à la politique de traitement des plaintes décrite ici. ",
    ],
    'headings' => [
        'head' => 'TITRES',
        'b1' => '" AxePro " fait référence à la Société, aux sociétés affiliées, aux subordonnés et à leurs bénéficiaires ;',
        ...
        'b3' => "L'Accord' fait référence à ce document et à toute autre forme formelle et écrite de
                déclarations, accords, permissions affirmés par le client.",
    ],
    'application' => [
        ...
        'b1' => "Les Conditions Générales prennent effet, et lient le Client et la Société, de toutes les
                obligations et droits fixés au moment où le Client a commencé à commercer en utilisant les services et technologies d'AxePro.
                ...
                l'acceptation par le Client des Conditions Générales. Les titres et les termes techniques utilisés dans les présentes sont
                références uniquement, et n'ont pas d'effet réel ni ne restreignent aucune des dispositions des Conditions
                conditions générales.",
        'b2' => 'La documentation légale telle que présentée sur le site officiel est la seule documentation de la société.
                la société, qui peut être fournie comme référence aux clients sur demande.
                Des certificats supplémentaires peuvent être fournis lors de réunions et de conférences personnelles.
                ',
    ],
    'eligibility' => [
        'head' => 'INSCRIPTION ET ÉLIGIBILITÉ',
        'reg' => "Inscription",
        'b1' => "A des fins d'identification et pour se conformer aux lois et aux exigences réglementaires existantes, le
                le client accepte de soumettre des documents d'identification valides et/ou toute référence d'information
                référence d'information obligatoire supplémentaire demandée par la Société. Ces
                informations et documents fournis jusqu'à présent authentifient l'identification du Client,
                empêchant ainsi la fraude et autres activités illégales. Si le Client ne fournit pas les documents
                documents nécessaires, la Société se réserve le droit de restreindre l'utilisation du service et/ou du compte de trading du Client.
                l'utilisation du service et/ou du compte de trading du Client.
                ",
        'eligibl' => 'Eligibilite',
        'b2' => "En utilisant les services de la Société, le Client accepte donc qu'il est éligible pour
                ...
                services fournis par AxePro sont destinés uniquement aux clients auxquels les lois de toute juridiction applicable n'interdisent pas d'acquérir des accords liés au trading.
                ...
                ne sera pas responsable de toute utilisation illégale ou non autorisée des services par le Client. Juridique
                Un conseil juridique dans la juridiction applicable est fortement recommandé si le client a des doutes sur la légalité de l'utilisation des services.
                doute sur la légalité de l'utilisation des services.",

    ],
    'offerings' => [
        'head' => "OFFRES DE L'ENTREPRISE",
        'b1' => "AxePro offre une variété de services de trading à ses clients, dont les suivants
    ...
    'funding' => [
        'head' => 'FINANCEMENT ET RETRAIT ',
        'b1' => "Une demande formelle doit être fournie par le client afin d'être initiée par la Société.
                Pour qu'une demande de retrait soit approuvée, le client affirme que son compte n'est pas
                n'a pas d'arriérés de paiement, qu'il a respecté les politiques de la Société et que le compte de trading ne doit pas avoir de transactions en cours.
                de la Société et que le compte de trading ne doit pas avoir de transactions en cours ou par les termes de la gestion des risques avec un accord signé supplémentaire.
                accord supplémentaire signé. Pour une telle demande en accord avec les Bonus de la Société, le
                client doit se conformer aux directives relatives aux bonus énoncées dans le présent document. ",

        'b2' => "En outre, le même pourcentage du montant demandé à être retiré du solde du client sera déduit de ses fonds de crédit.
                ...
                au retrait. AxePro se réserve le droit exclusif de rejeter toute autre procédure de retrait demandée par le client.
        ...
        'b3' => 'Les fonds qui ont été transférés par carte seront envoyés par la Société avec le même
                ...
                pour une demande de retrait plus élevée, qui sera traitée dans les trois à cinq jours ouvrables.
                jours ouvrables ; toute transaction de retrait par virement bancaire sera limitée à un minimum de 50 euros.',

    ],
    'refund_policy' => [
        'head' => 'POLITIQUE DE REMBOURSEMENT',
        'b1' => "Si le client a approvisionné son compte au moyen d'une carte de crédit, le paiement sera automatiquement débité de la carte.
                automatiquement débité de la carte. Si, pour quelque raison que ce soit, le client change d'avis concernant son
                financement pour quelque raison que ce soit, le client peut avoir le droit de demander le remboursement de son solde.
                solde restant, tandis que les conditions générales s'appliquent aux personnes qui ont reçu un
                bonus de la part de la Société.",

        'b2' => "Lors d'une demande de remboursement, le client doit fournir toutes les informations nécessaires requises par la Société et respecter la politique KYC.
                la Société, ainsi que respecter la politique KYC ; le client ne doit pas avoir de transactions ouvertes ou en attente sur son compte de trading.
                ouverts ou en attente sur son compte de trading. La demande de remboursement sera traitée
                par le département respectif de la Société dans un délai de deux jours ouvrables.
                nécessaires de la part du Client seront demandées par la Société par e-mail.",
        'b3' => "La Société n'est pas tenue d'informer le Client de la confirmation de sa demande de remboursement.
                confirmation de sa demande de remboursement, et la Société est libre d'approuver ou de refuser la
                demande de remboursement du Client soit approuvée ou refusée. En outre, si la Société fournit
                confirmation de la demande de remboursement du Client, le Client la recevra par e-mail. Sur
                demande de remboursement du Client, tous les justificatifs d'identité, comptes et adhésions à la
                Société seront désactivés. ",
        'b4' => "Le client comprend et reconnaît qu'il recevra ses remboursements
                par la même méthode et le même compte que ceux où il a effectué le dépôt..",

    ],
    'client_fund' => [
        'head' => 'FONDS CLIENT ',
        'b1' => "AxePro est autorisé à conserver les fonds du client pour les utiliser à des fins de négociation. Les pertes
        ...
        'b2' => "La société se réserve le droit de clôturer les comptes détenant l'investissement minimum de 100,00 USD et d'appliquer les frais nécessaires sans préavis au client.
                de 100.00 USD et d'appliquer les frais nécessaires sans préavis au client.",
        'b3' => 'En cas de non-activité pendant un an, la société peut facturer des frais de maintenance pour garder le compte accessible.
                le compte accessible. ',
    ...
    'fund_transfer' => [
        ...
        'b1' => "Dans le cas où le Client autorise une tierce personne à gérer son compte de trading
                compte de trading, le client affirme que cette action est réalisée à ses propres risques, car AxePro ne peut être tenu responsable de votre action et n'est pas obligé de faire des recommandations en la matière.
        ...
        'b2' => 'Si une demande de transfert de fonds entre deux sociétés clientes est initiée, les deux parties doivent soumettre une demande formelle soumise à approbation.
                doivent soumettre une demande formelle soumise à approbation. AxePro peut rejeter les demandes de
                de transfert de fonds. ',

    ],
    'responsibility' => [
        'head' => 'RESPONSABILITÉS CLIENT ET REMERCIEMENTS ',
        'b1' => "En utilisant les Services de la Société, le Client affirme qu'il est : ",

        'b2' => "Capable de s'engager dans des activités d'investissement financier et est d'âge légal en
                conformément à la juridiction dont relève ce qui précède.",
        'b3' => 'Pas un politicien ; ni affilié ni lié à un politicien de quelque manière que ce soit.',
        'b4' => "L'utilisation de fonds pour la négociation dans la société qui sont obtenus légalement et n'ont pas été
                acquis à partir d'activités illégales.",
        'b5' => "Ne pas accumuler d'intérêts sur son compte.",
        'b6' => "En outre, le client reconnaît qu'à l'expiration d'un contrat ou d'un actif, le fait de ne pas fermer les transactions en cours peut entraîner une sortie automatique.
        ...
        'b7' => "Toutes les conversations entre le client et le personnel d'AxePro peuvent être enregistrées électroniquement avec ou sans préavis.
                ...
                enregistrements sont la propriété exclusive de l'entreprise ; AxePro se réserve donc le
                AxePro se réserve donc le droit de refuser de fournir les enregistrements demandés. ",

    ],
    'bonus' => [
        'head' => 'DIRECTIVES SUR LES BONUS ',
        'b1' => "En utilisant les Services de la Société, le Client affirme qu'il est : ",

        'b2' => "Pour la commodité des clients, la Société peut, de temps à autre, lancer des promotions et accorder des bonus.
        ...
        'b3' => 'Les bonus et/ou les bénéfices obtenus grâce aux bonus ne pourront être retirés par le Client que si
                le volume de trading requis, déterminé par AxePro, est atteint (volume de trading minimum
        ...
        'b4' => "En cas d'utilisation des bonus sur son compte de trading, le client ne peut pas retirer les bénéfices générés sur son compte sans remplir les conditions et les conditions de trading requises.
                profit généré sur son compte sans avoir rempli les conditions et le volume de trading requis.
                volume.
                L'investissement peut être retiré en dix versements maximum, à condition que les directives relatives aux bonus ne soient pas respectées.
        ...
        'b5' => "En cas de suspicion d'activité frauduleuse en rapport avec le bonus et/ou les promotions,
                ...
                le compte de trading du Client. AxePro se réserve également le droit de bloquer le compte de trading du client et de restituer le solde.
    ...
    'seclusion' => [
        ...
        'b1' => "AxePro conduit les fonds qu'il détient au nom du client comme des fonds de clients. Le site
        ...
        'b2' => "AxePro se coordonne avec différents établissements de crédit ; une liste complète de ces
        ...
        'b3' => "En prenant en considération les attributs spéculatifs du trading en ligne, en acceptant ces conditions générales de vente, le client s'engage à ne pas demander le remboursement du service.
                conditions générales ; le client est tenu de ne pas demander de rétrofacturation pour le service
                considérant que la maintenance de la plateforme de trading, l'espace client, les nouvelles et les signaux
                font partie des services fournis.",
        'b4' => "Le processus de transfert de fonds vers le compte commercial du Client auprès de la Société dépendra de la méthode de paiement utilisée par le Client et de la période d'arrivée fixée sur le site.
                dépendra de la méthode de paiement utilisée par le Client et de la période d'arrivée fixée sur le
                processeur spécifique. ",
        'b5' => "Afin d'exécuter les commandes et/ou les transactions, la Société se réserve le droit de
                d'effectuer des conversions de devises sans en informer préalablement le Client.
                reconnaît le risque qui peut découler de toutes les conversions de devises. ",

    ],
    'fees' => [
        'head' => 'HONORAIRES, COMMISSIONS ET AUTRES COÛTS  ',
        'b1' => "Les clients peuvent être tenus de payer les coûts et les frais décrits dans les frais de service d'AxePro, y compris les commissions convenues.
                d'AxePro, y compris les commissions convenues, tandis que tous les montants dus seront déduits du
        ...
        'b2' => "Les paiements prévus aux présentes comprennent les parts de revenus, les commissions, les rabais et les écarts pour les tiers
                qui ont institué le lien professionnel entre les effectifs d'AxePro et
                les clients.    ",
        'b3' => "Les clients sont jusqu'à présent les seuls responsables du règlement des impôts, tandis que la Société n'est pas tenue de produire des recommandations concernant les obligations fiscales, les rapports et les déclarations.
                ...
                par an et d'un intérêt journalier supplémentaire (tel que déterminé par la Société) qui s'accumulera jusqu'à ce que le montant soit dû.
                s'accumuleront jusqu'à ce que le montant dû soit réglé.",
        'b4' => "En cas de réservation d'actions et d'autres liquidités, si l'ordre n'a pas été exécuté, le montant sera déduit du compte, proportionnellement à la valeur de l'ordre.
                n'a pas été exécuté, le montant sera déduit du compte, au prorata du
                montant.
                Lorsque la transaction est en attente sur le compte de transit, elle peut être clôturée en lots fractionnés,
                en compensant le profit négatif du profit total",

    ],
    'margin' => [
        'head' => 'EXIGENCE DE DÉPÔT ET MARGE DE DÉPÔT ',
        'b1' => "Les fonds sont nécessaires pour ouvrir des ordres et/ou effectuer des transactions. En outre, la
                ...
                être modifiées à tout moment. AxePro peut imposer des exigences maximales pour se conformer à des
        ...
        'b2' => "Les fonds du client pour la marge doivent être fournis par le client uniquement sous la forme d'argent réel
                ...
                compte et son niveau de marge, tandis qu'AxePro peut choisir de limiter les transactions et les
    ...
    'abritage' => [
        'head' => "LA POLITIQUE CONTRE L'ARBITRAGE, LA MANIPULATION ET L'UTILISATION D'UN CONSEILLER EXPERT
                ",
        'b1' => "AxePro interdit strictement toute forme d'arbitrage et de manipulation de sa plateforme,
                ...
                bénéfices obtenus, d'annuler les transactions, de bloquer le compte de trading du client et d'effectuer les
                et de procéder aux ajustements nécessaires sans préavis.  ",

    ],
    'derivatives_policy' => [
        'head' => 'POLITIQUE EN MATIÈRE DE PRODUITS DÉRIVÉS ',
        'b1' => "Le client peut passer des commandes en utilisant son ordinateur de bureau ou son téléphone portable. La société
                Société, aura le droit d'exécuter les ordres en fonction des données d'accès du client et
                au nom du client comme demandé.  ",
        'b2' => "La Société peut fixer des heures limites pour l'acceptation des instructions du client pour les ordres et dans
                ...
                question. AxePro peut exécuter les ordres du client, mais n'est pas obligé de le faire,
        ...
        'b3' => "Les ordres peuvent être placés, mis à jour ou supprimés pendant l'heure de négociation fixée.
                ...
                fermer des positions ouvertes et/ou ouvrir des positions à terme si la Société le juge nécessaire.
                nécessaire.",
        'b4' => 'Le client peut transférer son compte de trading pour une gestion temporaire, dans le cas où son
                compte présente des données statistiques positives et est considéré comme liquide par la bank.',
        'b5' => "Les CFD, le Forex et les autres instruments financiers sont des produits complexes. Ces
                produits sont volatils par nature, les conditions du marché étant modifiées chaque fois que
                jugées nécessaires, sans notification préalable. L'étendue des conditions de marché
                comprend, sans s'y limiter, l'effet de levier, les swaps, les frais de renouvellement, la taille des contrats, les spreads et les cotations,
                les spreads et les cotations de prix. ",

    ],
    'investment_advice' => [
        'head' => "RESTRICTION DU CONSEIL EN MATIÈRE D'INVESTISSEMENT ",
        'b1' => "Sur la base de ce que la Société considère comme fiable, AxePro et toutes ses forces de travail
    ...
    'disputes' => [
        'head' => 'RÈGLEMENT DES LITIGES ',
        'b1' => "Si le Client croit constater une divergence entre les résultats de trading affichés officiellement et ceux qui, à son avis, devraient être affichés (par ex.
                officiellement affichés et ceux qui devraient l'être à son avis (par ex : L'ordre placé
                l'ordre placé n'a pas été affiché ou a été modifié ; la position qui devait être ouverte est fermée ;
                la position qui doit être fermée n'est pas fermée ; l'apparition de positions et/ou d'ordres supplémentaires, etc.
                et/ou d'ordres supplémentaires, etc.), le client doit prendre des mesures immédiates pour remédier à la situation ou fermer immédiatement la ou les positions.
                fermer immédiatement la/les position(s). ",
        'b2' => 'Par la suite, le Client devra contacter le représentant de la Société par les moyens de communication disponibles ou par les contacts indiqués sur le site officiel de la Société.
                ...
                Société.',
        'b3' => "Si le Client ne se conforme pas à ces actions, il renonce à tout droit qu'il aurait pu avoir à l'égard d'AxePro concernant cette divergence, étant donné l'impossibilité d'y remédier.
                droits qu'il aurait pu avoir à l'égard d'AxePro concernant cette divergence depuis l'impossibilité
                ...
                quel que soit l'impact ultérieur du profit ou de la perte sur le montant total du profit et de la perte. Le non-respect de ces actions est considéré comme une incapacité à atténuer les pertes. Le client doit soumettre toute réclamation à AxePro par écrit à l'adresse e-mail :
                support@AxePro.com. ",
        'b4' => 'Dans un délai de trente (30) jours ouvrables, AxePro doit vérifier toute plainte écrite, si elle est suffisamment documentée, et présenter sa position à la Commission.
        ...
        'b5' => 'Le client, à son tour, ne fera aucune déclaration publique sous quelque forme que ce soit concernant sa
                ...
                clause, le client accepte de payer à AxePro un dédommagement pour atteinte à la réputation de 100,00
                cette violation, le maximum cumulé de ce paiement pouvant atteindre 10 000,00 $.',
        'b6' => "Le client et AxePro s'engagent à faire tout leur possible pour résoudre tout litige, de bonne foi et sur une base constructive.
                bonne foi et sur une base constructive. Le Client reconnaît et accepte que les menaces et/ou le
                chantage à l'encontre d'AxePro sont interdits et constituent le ou les motifs légitimes de la
                l'arrêt des négociations et la cessation immédiate de toute relation d'affaires.",
        'b7' => "Sans préjudice de tout autre droit d'AxePro en vertu des présentes Conditions, si les parties sont en
                parties sont en conflit au sujet d'un mandat commercial, AxePro a le droit, à sa seule
                sans notification préalable, d'accepter tout avis et toute action qu'il considère comme raisonnable pour limiter
                le montant maximal concerné par le litige. AxePro n'est pas responsable envers le Client,
    ...
    'indemnification' => [
        'head' => 'INDEMNISATION ',
        'b1' => "Vous reconnaissez qu'AxePro et ses collaborateurs ne pourront être tenus responsables de toute
                pertes, coûts, dépenses et dommages qui pourraient survenir dans le cas où le client n'accomplirait pas
                d'accomplir ses obligations dans le cadre du présent accord. AxePro est libre de toute responsabilité dans toutes
                réclamations qui pourraient avoir été provoquées par une erreur de système et/ou d'équipement d'AxePro
    ...
    'confidential' => [
        ...
        'b1' => "Les informations contenues dans le site officiel, les marques de commerce, les droits d'auteur et les droits de propriété intellectuelle sont la propriété exclusive d'AxePro et de ses concédants.
                droits de propriété intellectuelle sont la propriété exclusive d'AxePro et de ses concédants de licence. Tous ces éléments et
                documents de tiers ne doivent pas être modifiés, publiés ou distribués par les clients
                et/ou par toute autre tierce partie.
                avis.  ",

        'b2' => "Selon la politique de protection des données de l'entreprise, les employés de tous les départements ne peuvent pas
                ne peuvent pas effectuer de réunion vidéo avec les clients de l'entreprise. Une réunion privée est
                disponible dans des",
        'b3' => "Toute demande d'une réunion vidéo de la part d'un des représentants sera une violation directe
    ...
    'termination' => [
        ...
        'b1' => "Le présent contrat peut être résilié par le client à tout moment, sous réserve d'un préavis d'au moins cinq jours ouvrables.
                préavis d'au moins cinq jours ouvrables ; à condition que le client n'ait pas de positions ouvertes ; et qu'aucun montant ne soit dû à AxePro.
                positions ouvertes ; et qu'aucun montant ne soit dû par le client à AxePro. Le client peut
        ...
        'b2' => "La résiliation du présent accord ne libère pas les deux parties des obligations prévues par le présent accord.
                ...
                résiliation. Dans le cas où le client n'est pas disposé à remplir ses obligations antérieures à l'égard de la Société, AxePro se réserve le droit d'annuler l'accord.
                obligations envers la Société, AxePro se réserve le droit de rappeler tous les bénéfices
                générés par les services de la Société. AxePro a le droit unique et exclusif
                AxePro a le droit unique et exclusif d'apporter tout changement, mise à jour, altération aux Termes et
                notification préalable. ",

    ],
    'docs' => 'DOCUMENTS',
    'pri_pol' => 'Politique de confidentialité',
    'risk_dis' => 'Divulgation des risques',
    'trms' => "Conditions d'utilisation",
    'ordr' => "Politique d'exécution des commandes",
    'policies' => "Politiques",

    'body' => [
        'welcome' => 'Bienvenue',
        'depo' => 'DÉPÔTS',
        'withdraw_funds' => 'RETRAIT DES FONDS',
        'open' => 'OUVRIR DES COMPTES SUPPLÉMENTAIRES',
        'downloads' => 'TÉLÉCHARGEMENTS ',
        'deposited' => 'Déposé',
        'balance' => 'Solde',
        'bonus' => 'Prime',
        'personal_chart' => 'Tableau de trading personnel',
        'acnt' => 'Informations sur le profil du compte',
        'type' => 'Type de compte :',
        'email' => 'Courriel :',
        'enter_email' => 'Entrez votre courriel',
        'full_name' => 'Nom complet',
        'enter_full' => 'Entrez votre nom complet',
        ...
        'act' => 'Action',
        'new_demo' => 'Nouveau compte démo',
        'deposits' => 'Dépôts',
        'new_depo' => 'Nouveau dépôt',
        'account' => 'Compte',
        'amount' => 'Montant',
        'pay_method' => 'Mode de paiement',
        'my_with' => 'Mes retraits',
        'new_with' => 'Nouveau retrait',
        'metatrader' => 'Télécharger MetaTradre 5 pour PC, smartphones et tablettes',
    ...
    'withdrawal_details' => [
        ...
        'bank_addres' => 'Adresse de la banque',
        'swift' => 'Code Swift',
        'acnt_name' => 'Nom du compte',
        'acnt_num' => 'Numéro de compte',
        'cash' => 'Le Bitcoin Cash',
        'cash_addres' => 'Adresse de Bitcoin Cash',
        'interac' => 'Interac',
        'int_email' => 'Courriel Interac',
        'paypa' => 'Courriel Paypal',
        'bitcoin' => 'Bitcoin',
        'btc_addres' => 'Adresse de Btc',
        'ethereum' => 'Ethereum',
        'ethe_addres' => "Adresse d'Ethereum",
        '' => 'Litcoin',
        'ltc_addres' => 'Adresse du LTC
    ...
    'register' => [
        'crt' => 'créer un compte',
        'full' => 'Nom complet',
        'enter_ful' => 'Entrez le nom complet',
        'email' => 'Adresse électronique',
        'example' => 'nom@example.com',
        'num' => 'Numéro de téléphone',
        'enter_num' => 'Entrez le numéro de téléphone',
        'type' => 'Type de compte',
        'addrs' => "Entrez l'adresse",
        'town' => 'Ville',
        'state' => 'État/Région',
        'enter_stt' => "Entrez l'état",
        'zip' => 'Code postal',
        ...
        'reg' => 'Registre',
        'already' => 'Vous possédez déjà un compte ?',
        'log' => 'Connexion',
        'user_log' => "Connexion de l'utilisateur",
        'forget_pass' => 'Mot de passe oublié ?',
        'reset' => 'Réinitialiser',
        'dont_have' => "Vous n'avez pas encore de compte ?",
        'sign_up' => "Inscrivez-vous",

    ],
    'banktransfer' => [
        'send' => 'Vous envoyez',
        'below' => 'aux coordonnées bancaires ci-dessous',
        'detls' => 'Coordonnées bancaires',
        'bname' => 'Nom de la banque',
        'addrs' => 'Adresse de la banque',
        'code' => 'Code Swift',
        'name' => 'Nom du compte',
        'num' => 'Numéro de compte',
        'secd' => 'Coordonnées de la deuxième banque',
        'upload' => 'Télécharger la preuve de paiement après le paiement',
        'mode' => 'Mode de paiement utilisé',
    ...
    'chgepass' => [
        ...
        'knfrm' => 'Confirmer le mot de passe',
        'sub' => 'Soumettre',

    ],
    'coins' => [
        'send' => 'Vous envoyez',
        'walet' => "à l'adresse du portefeuille ci-dessous",
        'wadrs' => 'Adresse du portefeuille ',
        'check' => 'Vérifiez combien de ',
        'to' => 'vous devez envoyer',
        'markets' => 'Marchés pour acheter des crypto-monnaies',
        'buy' => 'Acheter maintenant',
        'upload' => 'Télécharger une Preuve',
    ],
      'forgot_pass' => [
        'pasreset' => 'Réinitialisation du mot de passe',
    ...
    'verify' => [
        'veri' => 'Vérification du compte',
        'status' => 'Statut KYC : Non vérifié',
        'kyc_veri' => 'Vérification KYC - Non activé.',
        'upload' => 'Vérification KYC - Téléchargez les documents ci-dessous pour être
        vérifiés (assurez-vous que les quatre coins du document sont visibles pour la vérification).
        vérification
        de vérification)',
    ...
    'modal' => [
        'make_new' => 'Effectuer un nouveau dépôt',
        'chose' => 'Choisissez un compte',
        'pay' => 'Le paiement sera envoyé à votre adresse de réception.',
        'enter' => 'Entrez le montant ici',
        'sub' => 'Soumettre',
        ...
        'cur' => 'Monnaie',
        'int' => 'Solde initial',
        'live' => 'Créer un compte en ligne',
        'sl' => 'Sélectionner le levier',
