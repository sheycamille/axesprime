        ...
        <div class="page-inner">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8 bg-{{$bg}} shadow-lg text-{{$text}} p-3">
                    ...
                    <h4> <strong>AMOUNT:</strong> {{\App\Models\Setting::getValue('currency')}}{{$cplan->amount}}</h4>
                ...
                <div class="col-lg-4">
                    <div class="card shadow border">
                        <div class="card-body bg-{{$bg}}">
                            ...
                            <h5 class="text-{{$text}}"> <b>ROI: </b> {{\App\Models\Setting::getValue('currency').$plan->dplan->increment_amount}}</h5>
                            @else
                            ...
                            <h5 class="text-{{$text}}"> <b>AMOUNT:</b> {{\App\Models\Setting::getValue('currency')}}{{$plan->amount}}</h5>
                            <h5 class="text-{{$text}}"> <b>DURATION: </b>{{$plan->inv_duration}}</h5>
                            <h5 class="text-{{$text}}"> <b>MIN RETURN: </b>{{\App\Models\Setting::getValue('currency').$plan->dplan->minr}}</h5>
                            <h5 class="text-{{$text}}"> <b>MAX RETURN: </b>{{\App\Models\Setting::getValue('currency').$plan->dplan->maxr}}</h5>
                            @if($plan->active=="yes")
                            <p style="color:green;">Active! <i class="glyphicon glyphicon-ok"></i></p>
