    ...
    <div class="content bg-{{$bg}}">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                ...
                <h5 id="ann" class="text-{{$text}}op-7 mb-4">{{\App\Models\Setting::getValue('newupdate')}}</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('currency')}}{{$deposited->count}}</h4>
                                        @else
                                        <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('')}}0.00</h4>
                                        @endif
                                        @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-9 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('currency')}}{{ number_format(Auth::user()->roi, 2, '.', ',')}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('currency')}} {{ number_format($total_bonus->bonus, 2, '.', ',')}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('currency')}}{{ number_format(Auth::user()->ref_bonus, 2, '.', ',')}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('currency')}}{{ number_format(Auth::user()->account_bal, 2, '.', ',')}}</h4> <br>
