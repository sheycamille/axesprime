                                            ...
                                            <div class="card-body">
                                                <div id="virtualpay" class="d-flex justify-content-center col-xs-12">
                                                    ...
                                                    <form id="payment" action="https://uat.evirtualpay.com/vpcheckout/index.php" method="POST">
                                                        <input type="hidden" name="MID"  value="{{ config('virtualpay.demo_mid') }}">
                                                        <input type="hidden" name="API_KEY" value="{{ config('virtualpay.demo_api_key') }}">
                                                        ...
                                                        <input type="hidden" name="NOTIFICATION_URL" value="{{ route('verifyvirtualpaycharge') }}">
                                                        <input type="hidden" name="FIRST_NAME" value="{{ Auth::user()->name }}">
                                                        <input type="hidden" name="LAST_NAME" value="{{ Auth::user()->name }}">
                                                        <input type="text" name="REQUESTID" value="{{ Auth::user()->id . time() }}">
                                                        <input type="hidden" name="MOBILE" value="{{ Auth::user()->phone }}">
                                                        <input type="hidden" name="EMAIL" value="{{ Auth::user()->email }}">
                                                        <input type="hidden" name="ID" value="{{ Auth::user()->id . time() }}">
                                                        <input type="hidden" name="CITY" value="{{ Auth::user()->town }}">
                                                        <input type="hidden" name="COUNTRY" value="{{ strtoupper(Auth::user()->country->code) }}">
                                                        <input type="hidden" name="AMOUNT" value="{{ $amount }}">
                                                        <input type="hidden" name="CURRENCY" value="USD">
                                                        <input type="hidden" name="DESCRIPTION" value="Account {{ Auth::user()->id }} pay {{ $amount }}usd">
                                                        <input type="hidden" name="POSTAL CODE" value="{{ Auth::user()->zip_code }}">
                                                        <input type="hidden" name="STATE CODE" value="{{ Auth::user()->state }}">
                                                        <br>
