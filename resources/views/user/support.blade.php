                    ...
                    <div class="shadow col-12 p-md-2">
                        <div class="col-12 text-center bg-{{ $bg }} p-3">
                            <h1 class="title1 text-{{ $text }} text-center">
                                {{ \App\Models\Setting::getValue('site_name') }} Support</h1>
                            <div class="sign-up-row widget-shadow text-{{ $text }}">
                                <h4 class="text-{{ $text }}">For inquiries, suggestions or complains. Mail us at
                                </h4>
                                <h5 class="text-{{ $text }} mt-3">
                                    {{ \App\Models\Setting::getValue('contact_email') }}
                            </div>
                        </div>
                        <div class="col-md-8 offset-md-2">
                            <form method="post" action="{{ route('enquiry') }}">
                                ...
                                <div class="form-group">
                                    <h5 for="" class="text-{{ $text }}">Subject <span class=" text-danger">*</span>
                                    </h5>
                                    <input type="text" name="subject"
                                        class="form-control text-{{ $text }} bg-{{ $bg }}" required>
                                </div>
                                <div class="form-group">
                                    <h5 for="" class="text-{{ $text }}">Message<span class=" text-danger">*</span>
                                    </h5>
