        ...
        <div class="page-inner">
            ...
            <div class="mb-5 row">
                <div class="col-lg-8 offset-lg-2 card bg-{{$bg}} shadow-lg p-lg-3 p-sm-5">
                    <h2 class="text-{{$text}}">{{\App\Models\Setting::getValue('site_name')}} Account manager</h2> <br>
                    <div clas="well">
                        <p class="text-justify text-{{$text}}">Don’t have time to trade or learn how to trade?
                            ...
                            <small>Terms and Conditions apply</small><br>Reach us at {{\App\Models\Setting::getValue('contact_email')}}
                            for more info.</p>
                    </div>
                    <br>
                    <div>
                        ...
                        <a type="button" class="mb-2 text-white btn btn-danger" data-toggle="modal" data-target="#submitmt4modal">
                            Submit MT4 Details
                        </a>
                    </div>
