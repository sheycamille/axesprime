            ...
            <div class="row">
                <div class="col card bg-{{$bg}} shadow-lg p-4">
                    ...
                    <form action="charge" method="post">
                        ...
                        <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="{{\App\Models\Setting::getValue('s_p_k')}}" data-image="https://stripe.com/img/documentation/checkout/marketplace.png" data-name="{{\App\Models\Setting::getValue(site_name'')}}" data-description="Account fund" data-amount="{{$t_p}}" data-locale="auto">
                        </script>
                    </form>
                    @else
                    <div class="mb-3 text-{{$text}}">
                        <h4>You are to make payment of <strong>{{\App\Models\Setting::getValue('currency')}}{{$amount}}</strong> using your preferred mode of payment below. Screenshot the proof of payment</h4>
                        <?php
                            ...
                            <div class="card bg-{{$bg}} shadow text-{{$text}}">
                                <div class="card-body">
                                    ...
                                    <div id="bank" class="panel-collapse collapse">
                                        <div class="">
                                            <h4 class="text-{{$text}}"><strong>Bank name:</strong> {{\App\Models\Setting::getValue('bank_name')}}.</h4>
                                            <h4 class="text-{{$text}}"><strong>Account name:</strong> {{\App\Models\Setting::getValue('account_name')}}.</h4>
                                            <h4 class="text-{{$text}}"><strong>Account number:</strong> {{\App\Models\Setting::getValue('account_number')}}.</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card bg-{{$bg}} shadow text-{{$text}}">
                                <div class="card-body">
                                    ...
                                    <div id="btc" class="panel-collapse collapse">
                                        <div class="">
                                            <h4 class="text-{{$text}}">
                                                <strong>BTC Address:</strong> {{\App\Models\Setting::getValue('btc_address')}}

                                                <br /><br />
                                                @if(\App\Models\Setting::getValue('withdrawal_option') != "manual")
                            ...
                            <div class="card bg-{{$bg}} shadow text-{{$text}}">
                                <div class="card-body">
                                    ...
                                    <div id="eth" class="panel-collapse collapse">
                                        <div class="">
                                            <h4 class="text-{{$text}}">
                                                <strong>ETH Address:</strong> {{\App\Models\Setting::getValue('eth_address')}}
                            ...
                            <div class="card bg-{{$bg}} shadow text-{{$text}}">
                                <div class="card-body">
                                    ...
                                    <div id="ltc" class="panel-collapse collapse">
                                        <div class="">
                                            <h4 class="text-{{$text}}">
                                                <strong>LTC Address:</strong> {{\App\Models\Setting::getValue('ltc_address')}}
                                                <br /><br />
                                                @if(\App\Models\Setting::getValue('withdrawal_option') != "manual")
                                    ...
                                    <div id="stripe" class="panel-collapse collapse">
                                        <div class="pt-2">
                                            ...
                                            <script type="text/javascript">
                                                var stripe = Stripe("<?php echo \App\Models\Setting::getValue('s_p_k'); ?>");
                    ...
                    <h4>Contact management at <strong>{{\App\Models\Setting::getValue('contact_email')}}</strong> for other payment methods.</h4>
                </div> --}}
                <div>
