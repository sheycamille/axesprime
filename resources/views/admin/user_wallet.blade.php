    ...
    <div class="main-panel">
        <div class="content bg-{{ Auth('admin')->User()->dashboard_style }}">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h1 class="title1 text-{{ $text }} text-center"> {{ $user }} Wallet Details</h1>
                </div>
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title text-{{ $text }}">
                                                    {{ \App\Models\Setting::getValue('currency') }}{{ number_format($roi, 2, '.', ',') }}
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title text-{{ $text }}">
                                                    {{ \App\Models\Setting::getValue('currency') }}{{ number_format($account_bal, 2, '.', ',') }}
                                                </h4> <br>
                                            </div>
                                        </div>
                                    </div>
