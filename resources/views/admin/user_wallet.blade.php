                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('currency')}}{{ number_format($roi, 2, '.', ',')}}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('currency')}} {{ number_format($bonus, 2, '.', ',')}}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('currency')}}{{ number_format($ref_bonus, 2, '.', ',')}}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title text-{{$text}}">{{\App\Models\Setting::getValue('currency')}}{{ number_format($account_bal, 2, '.', ',')}}</h4> <br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
