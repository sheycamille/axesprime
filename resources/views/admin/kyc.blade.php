    ...
    <div class="main-panel bg-{{ Auth('admin')->User()->dashboard_style }}">
        <div class="content bg-{{ Auth('admin')->User()->dashboard_style }}">
            <div class="page-inner">
                ...
                <div class="mb-5 row">
                    <div class="col-12">
                        <small class="text-{{ $text }}">if you can't see the image, try switching your uploaded
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a href="{{ url('admin/dashboard/resetkyc') }}/{{ $user->id }}"
                                        ...
                                        <!-- View KYC ID Modal -->
                                        <div id="viewkycIModal{{ $user->id }}" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div
                                                        ...
                                                        <h4 class="modal-title text-{{ $text }}">KYC verification -
                                                            ID card view</h4>
                                                    ...
                                                    <div
                                                        ...
                                                        @if (\App\Models\Setting::getValue('location') == 'Email')
                                                            <h3 class="text-{{ $text }}">Check your email with the
                                                                KYC upload that has an attachment name of
                                                                <span class="text-danger">{{ $user->id_card }}</span>
                                                            </h3>
                                        ...
                                        <div id="viewkycIBModal{{ $user->id }}" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                        ...
                                        <div id="viewkycPModal{{ $user->id }}" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div
                                                        ...
                                                        @if (\App\Models\Setting::getValue('location') == 'Email')
                                                            <h3 class="text-{{ $text }}">Check your email with the
                                                                KYC upload that has an attachment name of
                                                                <span class="text-danger">{{ $user->passport }}</span>
                                                            </h3>
                                                        @elseif(\App\Models\Setting::getValue('location') == "S3")
                                                            @php
                                        ...
                                        <div id="viewkycAModal{{ $user->id }}" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
