...
<div class="main-panel bg-{{Auth('admin')->User()->dashboard_style}}">
    <div class="content bg-{{Auth('admin')->User()->dashboard_style}}">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                <h1 class="title1 text-{{$text}} text-center">Edit Front Page of this site</h1>
            </div>
            ...
            <div class="mb-5 row">
                            ...
                            <div class="p-1 col-md-4">
                                <div class="card border p-1 bg-{{Auth('admin')->User()->dashboard_style}}">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title text-{{$text}}"><strong>{{$test->name}}</strong> </h5>
                                        <p class="card-text text-{{$text}}">{{$test->what_is_said}}</p>
                                    </div>
                                    <ul class="list-group list-group-flush ">
                                        <li class="list-group-item bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}"> {{$test->position}}</li>
                                        <li class="bg-{{Auth('admin')->User()->dashboard_style}} list-group-item text-{{$text}}">{{$test->picture}}</li>
                                    </ul>
                                    <div class="card-body">
                                        <a href="{{ url('admin/dashboard/deltestimony') }}/{{$test->id}}" type="button" data-toggle="tooltip" title="" class="btn btn-sm btn-danger" data-original-title="Remove"><i class="fa fa-times"></i></a> &nbsp; &nbsp;
                                        <a href="#" data-toggle="modal" data-target="#edittes{{$test->id}}" class="btn btn-primary btn-sm">Edit</a>
                                    </div>
                                </div>
                            </div>
                            <div id="edittes{{$test->id}}" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header bg-{{Auth('admin')->User()->dashboard_style}}">
                                        ...
                                        <div class="modal-body bg-{{Auth('admin')->User()->dashboard_style}}">
                                            <form action="{{route('updatetestimony')}}" method="post">
                                                ...
                                                <div class="form-group">
                                                    <h5 class="text-{{$text}}">Testifier Name</h5>
                                                    <input type="text" name="testifier" placeholder="Full name" value="{{$test->name}}" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class=" text-{{$text}}">Position</h5>
                                                    <input type="text" name="position" value="{{$test->position}}" placeholder="System user or anonymus" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class=" text-{{$text}}">What testifier said</h5>
                                                    <textarea name="said" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" rows="4">{{$test->what_is_said}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <h5 class=" text-{{$text}}">Picture</h5>
                                                    <select name="picture" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}">
                ...
                <div class="tab-pane fade show active card bg-{{Auth('admin')->User()->dashboard_style}} p-3" id="3" role="tabpanel" aria-labelledby="nav-contact-tab">
                    <div class="boxes">
                        <div class="row">
                            ...
                            <div class="p-1 col-md-3">
                                <div class="card border p-1 bg-{{Auth('admin')->User()->dashboard_style}}">
                                    <div class="card-body">
                                        <h5 class="card-title text-{{$text}}"><strong>{{$content->title}}</strong> </h5>
                                        <p class="card-text text-{{$text}}">{{$content->description}}</p>

                                        <a href="#" data-toggle="modal" data-target="#editcont{{$content->id}}" class="btn btn-primary btn-sm">Edit</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body bg-{{Auth('admin')->User()->dashboard_style}}">
                                            <form action="{{route('updatecontents')}}" method="post">
                                                ...
                                                <div class="form-group">
                                                    <h5 class=" text-{{$text}}">Title of Content</h5>
                                                    <input type="text" name="title" placeholder="Name of Content" value="{{$content->title}} " class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-{{$text}}">Content Description</h5>
                                                    <textarea name="content" placeholder="Describe the content" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" rows="2" required>{{$content->description}}</textarea>
                                                </div>
                ...
                <div class="tab-pane fade card bg-{{Auth('admin')->User()->dashboard_style}} p-3" id="4" role="tabpanel" aria-labelledby="nav-about-tab">
                    <div class="boxes">
                        <div class="row">
                            ...
                            <div class="p-1 col-md-4">
                                <div class="card border p-1 bg-{{Auth('admin')->User()->dashboard_style}}">
                                    <img src="{{ asset('storage/photos/'.$image->img_path)}}" class="card-img-top w-50" alt="Image">

                                    <div class="card-body">
                                        <h5 class="card-title text-{{$text}}"><strong>{{$image->title}}</strong> </h5>
                                        <p class="card-text text-{{$text}}">{{$image->description}}</p>
                                    </div>
                                    <div class="card-body">
                                        <a href="#" data-toggle="modal" data-target="#editimg{{$image->id}}" class="btn btn-primary btn-sm">Edit</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body bg-{{Auth('admin')->User()->dashboard_style}}">
                                            <form action="{{route('updateimg')}}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <h5 class="text-{{$text}}">Title of Image</h5>
                                                    <input type="text" name="img_title" value="{{$image->title}}" placeholder="Name of Image" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-{{$text}}">Images Description</h5>
                                                    <textarea name="img_desc" placeholder="Describe the image" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" rows="2">{{$image->description}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-{{$text}}">Image</h5>
                                                    <input name="image" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" type="file">
