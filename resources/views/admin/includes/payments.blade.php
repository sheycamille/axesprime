...
<form method="post" action="{{route('updatesettings')}}" enctype="multipart/form-data">
    ...
    <div class="form-group">
       <select name="withdrawal_option" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}">
            <option value="{{\App\Models\Setting::getValue('withdrawal_option')}}">Currently ({{\App\Models\Setting::getValue('withdrawal_option')}})</option>
    ...
    <div class="panel panel-default">
        ...
        <div class="sign-up2">
            <input type="text" name="bank_name" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('bank_name')}}">
        </div>
    </div>
    ...
    <div class="sign-u">
        ...
        <div class="sign-up2">
            <input type="text" name="account_name" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('account_name')}}">
        </div>
    ...
    <div class="sign-u">
        ...
        <div class="sign-up2">
            <input type="text" name="account_number" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('account_number')}}">
        </div>
    </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-up2">
            <input type="text" name="btc_address" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('btc_address')}}">
        </div>
    </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-up2">
            <input type="text" name="ltc_address" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('ltc_address')}}">
        </div>
    </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="eth_address" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('eth_address')}}">
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="s_s_k" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('s_s_k')}}">
            </div>
        </div>
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="s_p_k" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('s_p_k')}}">
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="pp_ci" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('pp_ci')}}">
            </div>
        </div>
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="pp_cs" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}" value="{{\App\Models\Setting::getValue('pp_cs')}}">
            </div>
        </div>
        </div>
    </div> <br> <br>
...
<div id="cpdModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body bg-{{Auth('admin')->User()->dashboard_style}}">
                <form role="form" method="post" action="{{route('updatecpd')}}">
