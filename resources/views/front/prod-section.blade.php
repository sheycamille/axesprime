        ...
        <div class="uk-section in-liquid-7 in-offset-top-10">
            <div class="uk-container">
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center" style="background-image: url({{ asset('front/img/in-liquid-7-bg.png') }});" data-uk-img="">
                        ...
                        <div class="uk-grid-medium uk-child-width-1-3@s uk-child-width-1-3@m uk-text-center uk-margin-top uk-grid" data-uk-grid="">
                            <div class="uk-first-column">
                                <img src="{{ asset('front/img/in-liquid-award.svg') }}" data-src="{{ asset('front/img/in-liquid-award.svg') }}" alt="wave-award" width="71" height="58" data-uk-img="">
                        ...
                        <img class="uk-align-center" src="{{ asset('front/img//in-liquid-7-mockup.png') }}" data-src="{{ asset('front/img//in-liquid-7-mockup.png') }}" alt="sample-images" width="691" height="420" data-uk-img="">
            ...
            <div class="uk-container uk-light">
                <div class="uk-grid-medium uk-child-width-1-3@m uk-flex uk-flex-middle uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        ...
                        <a class="uk-button uk-button-default uk-border-rounded uk-margin-top" href="#">@lang('message.start_trading')<i class="fas fa-angle-right uk-margin-small-left"></i></a>
                    </div>
                    <div>
                        <div class="uk-card uk-card-secondary uk-card-body uk-border-rounded uk-text-center">
                            <img class="uk-margin-small-bottom" src="{{ asset('front/img/in-liquid-icon-17.svg') }}" data-src="{{ asset('front/img/in-liquid-icon-17.svg') }}" alt="wave-award" width="72" height="72" data-uk-img="">
                    ...
                    <div>
                        <div class="uk-card uk-card-secondary uk-card-body uk-border-rounded uk-text-center">
                            <img class="uk-margin-small-bottom" src="{{ asset('front/img/in-liquid-icon-18.svg') }}" data-src="{{ asset('front/img/in-liquid-icon-18.svg') }}" alt="wave-award" width="72" height="72" data-uk-img="">
                            <h3 class="uk-margin-top">AxePro Platform</h3>
                ...
                <div class="uk-grid uk-child-width-1-2@s uk-child-width-1-4@m uk-text-center" data-uk-grid>
                    ...
                    <div>
                        <div class="in-liquid-16-counter">
                            ...
                            <h3 class="uk-text-muted uk-margin-top uk-margin-remove-bottom">
                                <span class="count" data-counter-end="90" data-counter-append=" awards">90+ @lang('message.awards')</span>
                            </h3>
                        </div>
                    </div>
                    <div>
