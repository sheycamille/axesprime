...
<body>
    <div class="container">
        <div class="section">
            ...
            $url = \App\Model\Setting::getValue('site_address') .'/symlink.php';
            $curl = curl_init();
              ...
              if($activate_response['status'] != true){ ?>
                    <form action="activate" method="POST">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="text" placeholder="enter your purchase/license code" name="license" value="NullJungle" required>
                            </div>
                        </div>
                        <div class="field">
                            <label class="label">Your name</label>
                            <div class="control">
                                <input class="input" type="text" placeholder="enter your name/envato username" name="client" value="NullJungle" required>
                            </div>
                        </div>
