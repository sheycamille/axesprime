                ...
                <div class="uk-container" data-uk-navbar>
                        ...
                        <div class="uk-navbar-item">
                            ...
                            <ul class="uk-navbar-nav uk-visible@m">
                                ...
                                <li><a href="{{ route('about') }}">Company<i class="fas fa-chevron-down"></i></a>
                                    <div class="uk-navbar-dropdown">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                                            <li><a href="{{ route('about') }}">About AxePro</a></li>
                    ...
                    <div class="uk-navbar-right">
                        <div class="uk-navbar-item uk-visible@m in-optional-nav">
                            <a href="{{ route('register') }}" class="uk-button uk-button-primary uk-border-rounded" style="margin-right: 10px;">Create Account</a>
                            <a href="{{ route('login') }}" class="uk-button uk-button-primary uk-border-rounded">Login <i class="fas fa-user-circle"></i></a>
                        </div>
                    </div>
                </div>
            </nav>
        ...
        <div class="uk-section uk-background-secondary uk-light">
            <div class="uk-container uk-text-small">
                ...
                <div class="uk-grid uk-margin-large-top">
                    <div class="uk-width-1-1">
                        <p class="uk-heading-line uk-margin-large-bottom"><span>Copyright ©2022 AxePro Group. All Rights Reserved.</span></p>
