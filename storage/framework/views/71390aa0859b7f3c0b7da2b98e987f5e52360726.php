<?php $__env->startSection('title', 'Economic Calender'); ?>

<?php $__env->startSection('calender-menu-item', 'active'); ?>
                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center" data-uk-img="">
                        <div class="uk-text-center">
                            <h1 class="uk-margin-remove"><?php echo app('translator')->get('message.economic_calender.calender'); ?></h1>
                            <p class="uk-text-lead uk-text-muted uk-margin-small-top"><?php echo app('translator')->get('message.economic_calender.become'); ?>
                ...
                <div class="row">
                    ...
                    <div class="tradingview-widget-container" style="width: 100%; height: 1000px;">
                        <iframe scrolling="no" allowtransparency="true" frameborder="0"
                            src="https://www.tradingview-widget.com/embed-widget/events/?locale=en#%7B%22width%22%3A%22100%25%22%2C%22height%22%3A%221000%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22importanceFilter%22%3A%22-1%2C0%2C1%22%2C%22utm_source%22%3A%22axeprogroup.com%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22events%22%7D"
            ...
            <div class="uk-container">
                <div class="uk-grid-large uk-grid" data-uk-grid="">
                    <div class="uk-width-1-1@m uk-first-column">
                        <h3 class="uk-margin-small-bottom"><?php echo app('translator')->get('message.economic_calender.how_to_use_calender'); ?></h3>
                        <p class="uk-text-lead uk-text-muted uk-margin-remove-top uk-margin-medium-bottom"
                            style="font-size: 1rem;"><?php echo app('translator')->get('message.economic_calender.assist'); ?>.</p>
            ...
            <div class="uk-container">
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center"
                        style="background-image: url(<?php echo e(asset('front/img/in-liquid-7-bg.png')); ?>);" data-uk-img="">
                        <div class="uk-text-center">
                            <h2 class="uk-margin-remove">Why Trade with AxePro</h2>
                            <p class="uk-text-lead uk-text-muted uk-margin-small-top">Improve your trading results with
                                our industry-leading technology</p>
                        </div>
                        <div class="uk-grid-medium uk-child-width-1-3@s uk-child-width-1-3@m uk-text-center uk-margin-top uk-grid"
                            data-uk-grid="">
                            <div class="uk-first-column">
                                <img src="<?php echo e(asset('front/img/in-liquid-award.svg')); ?>" data-src="<?php echo e(asset('front/img//in-liquid-award.svg')); ?>" alt="wave-award"
                        ...
                        <img class="uk-align-center" src="<?php echo e(asset('front/img//in-liquid-7-mockup.png')); ?>"
                            data-src="<?php echo e(asset('front/img//in-liquid-7-mockup.png')); ?>" alt="sample-images" width="691" height="420"
                          >
                        ...
                        <div class="uk-text-center uk-margin-medium-top">
                            <a class="uk-button uk-button-primary uk-border-rounded uk-margin-small-right"
                                href="#">Create account<i class="fas fa-angle-right uk-margin-small-left"></i></a>
                            <a class="uk-button uk-button-secondary uk-border-rounded" href="#">Discover platform<i
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/front/economic-calender.blade.php ENDPATH**/ ?>