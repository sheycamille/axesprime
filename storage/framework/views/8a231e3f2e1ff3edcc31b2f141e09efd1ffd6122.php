...
<div class="main-panel bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
    <div class="content bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                <h1 class="title1 text-<?php echo e($text); ?>"><?php echo e(\App\Models\Setting::getValue('site_name')); ?> KYC Verifications</h1>
            </div>
            ...
            <div class="mb-5 row">
                <div class="col-12">
                    <small class="text-<?php echo e($text); ?>">if you can't see the image, try switching your uploaded location to another option from your admin settings page.</small>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#viewkycAModal<?php echo e($list->id); ?>" class="btn btn-<?php echo e($text); ?> btn-sm"><i class="fa fa-eye"></i> Address Document</a>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                                                ...
                                                <h3 class="text-<?php echo e($text); ?>">Check your email with the KYC upload that has an attachment name of
                                                    <span class="text-danger"><?php echo e($list->id_card); ?></span></h3>
                                                <?php elseif(\App\Models\Setting::getValue('location') == "Local"): ?>
                                                <img src="<?php echo e(asset('storage/photos/'.$list->id_card)); ?>" alt="ID Card" title="" class="img-fluid" />
                                                ...
                                                <?php else: ?>
                                                <img src="<?php echo e(asset('storage/photos/'.$list->passport)); ?>" alt="Passport" title="" class="img-fluid" />
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                                                ...
                                                <?php if(\App\Models\Setting::getValue('location') == "Email"): ?>
                                                <h3 class="text-<?php echo e($text); ?>">Check your email with the KYC upload that has an attachment name of
                                                    <span class="text-danger"><?php echo e($list->passport); ?></span></h3>
                                                <?php elseif(\App\Models\Setting::getValue('location') == "S3"): ?>
                                                <?php
                                ...
                                <div id="viewkycAModal<?php echo e($list->id); ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">

                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <div class="modal-header bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> ">
                                                <h4 class="modal-title text-<?php echo e($text); ?>">KYC verification - Address Document view</h4>
                                                <button type="button" class="close text-<?php echo e($text); ?>" data-dismiss="modal">&times;</button>
                                            </div>
                                            <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                                                ...
                                                <?php if(\App\Models\Setting::getValue('location') == "Email"): ?>
                                                <h3 class="text-<?php echo e($text); ?>">Check your email with the KYC upload that has an attachment name of
                                                    <span class="text-danger"><?php echo e($list->address_document); ?></span></h3>
                                                <?php elseif(\App\Models\Setting::getValue('location') == "S3"): ?>
                                                <?php
                                                ...
                                                <?php else: ?>
                                                <img src="<?php echo e(asset('storage/photos/'.$list->address_document)); ?>" alt="Address Document" title="" class="img-fluid" />
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
