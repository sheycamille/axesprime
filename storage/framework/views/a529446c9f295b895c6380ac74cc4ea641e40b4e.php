...
<?php $__env->startSection('shares-menu-item', 'active'); ?>

<?php $__env->startSection('content'); ?>
<main id="main" class="shares-page">
                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center">
                        <div class="uk-text-center">
                            <h1 class="uk-margin-remove">Share & Stock trading</h1>
                            <p class="uk-text-lead uk-text-muted uk-margin-small-top">Trade CFDs on thousands of global shares and benefit from ultra-fast order execution and competitive trading conditions. Trade CFDs on shares of some of the largest and most popular companies in the US, UK, and EU.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uk-container">
                <div class="uk-grid-large uk-child-width-1-2@m uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        ...
                        <h3 class="uk-margin-remove">The most popular shares are those that combine the shares of some of the largest and globally acknowledged companies.</h3>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/front/shares.blade.php ENDPATH**/ ?>