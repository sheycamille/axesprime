             ...
             <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                 <form style="padding:3px;" role="form" method="post" action="<?php echo e(route('sendmailtoall')); ?>">
                     ...
                     <textarea
                         ...
                         name="message" row="3" placeholder="Type Message here" required></textarea><br />
 ...
 <div id="wmethodModal" class="modal fade" role="dialog">
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             ...
             <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                 <form style="padding:3px;" role="form" method="post" action="<?php echo e(route('addwdmethod')); ?>">
                     <input style="padding:5px;"
                         class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>"
                         placeholder="Enter method name" type="text" name="name" required><br />
                     <input style="padding:5px;"
                         class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>"
                         placeholder="Enter method exchange symbol" type="text" name="exchange_symbol"
                         value="<?php echo e($method->exchange_symbol); ?>"><br>
                     <input style="padding:5px;"
                         class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>"
                         placeholder="Enter method setting key" type="text" name="setting_key"
                         value="<?php echo e($method->setting_key); ?>"><br>
                     <input style="padding:5px;"
                         class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>"
                         placeholder="Minimum amount $" type="text" name="minimum" required><br />
                     <input style="padding:5px;"
                         class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>"
                         placeholder="Maximum amount $" type="text" name="maximum" required><br />
                     <input style="padding:5px;"
                         class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>"
                         placeholder="Charges (Fixed amount $)" type="text" name="charges_fixed" required><br />
                     <input style="padding:5px;"
                         class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>"
                         placeholder="Charges (Percentage %)" type="text" name="charges_percentage" required><br />
                     <input style="padding:5px;"
                         class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>"
                         placeholder="Payout duration" type="text" name="duration" required><br />
                     <select name="status"
                         class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>">
 ...
 <div id="dmethodModal" class="modal fade" role="dialog">
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             <div class="modal-header bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                 <h4 class="modal-title text-<?php echo e($text); ?>">Add Deposit Method</h4>
                 <button type="button" class="close text-<?php echo e($text); ?>" data-dismiss="modal">&times;</button>
             </div>
             <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                 <form style="padding:3px;" role="form" method="post" action="<?php echo e(route('addwdmethod')); ?>">
 ...
 <div id="accountTypeModal" class="modal fade" role="dialog">
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             <div class="modal-header bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                 <h4 class="modal-title text-<?php echo e($text); ?>">Add Account Type</h4>
                 <button type="button" class="close text-<?php echo e($text); ?>" data-dismiss="modal">&times;</button>
             </div>
             <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                 <form style="padding:3px;" role="form" method="post" action="<?php echo e(route('addaccounttype')); ?>">
                     <h5 class="text-<?php echo e($text); ?>">Name</h5>
                     <input style="padding:5px;"
                         class="form-control text-<?php echo e($text); ?> bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>"
                         placeholder="Enter name" type="text" name="name" required><br />
                     <h5 class="text-<?php echo e($text); ?>">Cosy</h5>
                     <input style="padding:5px;"
                         class="form-control text-<?php echo e($text); ?> bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>"
                         placeholder="Enter price" type="text" name="price" required><br />
                     <h5 class="text-<?php echo e($text); ?>" Minimum Price</h5>
                         <input style="padding:5px;" placeholder="Enter minimum price"
                             class="form-control text-<?php echo e($text); ?> bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>"
                             type="text" name="min_price" required><br />
                         <h5 class="text-<?php echo e($text); ?>" Maximum Price</h5>
                             <input style="padding:5px;"
                                 class="form-control text-<?php echo e($text); ?> bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>"
                                 placeholder="Enter maximum price" type="text" name="max_price" required><br />

                             <h5 class="text-<?php echo e($text); ?>">Minimum return</h5>
                             <input style="padding:5px;"
                                 class="form-control text-<?php echo e($text); ?> bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>"
                                 placeholder="Enter minimum return" type="text" name="minr" required><br />

                             <h5 class="text-<?php echo e($text); ?>">Maximum return</h5>
                             <input style="padding:5px;"
                                 class="form-control text-<?php echo e($text); ?> bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>"
                                 placeholder="Enter maximum return" type="text" name="maxr" required><br />
                             <h5 class="text-<?php echo e($text); ?>">Gift Bonus</h5>
                             <input style="padding:5px;"
                                 class="form-control text-<?php echo e($text); ?> bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>"
                                 placeholder="Enter Additional Gift Bonus" type="text" name="gift" required><br />
                             ...
                             <input style="padding:5px;"
                                 class="form-control text-<?php echo e($text); ?> bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>"
                                 placeholder="top up amount" type="text" name="t_amount" required> <br>
     ...
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             ...
             <div class="modal-body bg-dark">
                 <h3><?php echo e(\App\Models\Setting::getValue('updated_by')); ?></h3>

                 <h4 class="modal-title" style="text-align:center;">Date/Time</h4>

                 <h3><?php echo e(\App\Models\Setting::getValue('updated_at')); ?></h3>
             </div>
         </div>
     </div>
 </div>
