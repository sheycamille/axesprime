                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                                                ...
                                                <h4 class="text-<?php echo e($text); ?>">This Payment was either made with credit/debit card, admin topup or automatic crypto payment hence no proof of payment provided</h4>
                                                <?php else: ?>
                                                <?php if(\App\Models\Setting::getValue('location') == "Email"): ?>
                                                <h3 class="text-<?php echo e($text); ?>">Check your email with the deposit that has an attachment name of
                                                    <span class="text-danger"><?php echo e($deposit->proof); ?></span></h3>
                                                <?php elseif(\App\Models\Setting::getValue('location') == "Local"): ?>
                                                <img src="<?php echo e(asset('storage/photos/'.$deposit->proof)); ?>" alt="Payment proof" title="" class="img-fluid" />
                                                <?php else: ?>
                                                <?php
                                                ...
                                                ?>
                                                <img src="<?php echo e($psrc); ?>" alt="Proof of Payment" title="" class="img-fluid" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadingaleonardngonga/Downloads/online-trade-06-04-2021/resources/views/admin/mdeposits.blade.php ENDPATH**/ ?>