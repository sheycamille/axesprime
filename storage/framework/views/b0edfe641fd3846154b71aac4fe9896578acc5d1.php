...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('front/favicon.png')); ?>"
        type="image/png" />
    ...
    <!-- Font preload -->
    <link rel="preload" href="<?php echo e(asset('front/fonts/inter-v2-latin-regular.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="<?php echo e(asset('front/fonts/inter-v2-latin-500.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="<?php echo e(asset('front/fonts/inter-v2-latin-700.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    ...
    <link href="<?php echo e(asset('front/css/auth.css')); ?>" rel="stylesheet">
...
<body>
    <header>
        ...
        <div class="uk-section uk-padding-remove-vertical in-header-inner uk-background-cover uk-background-top-center" style="background-image: url(<?php echo e(asset('front/img/in-liquid-slide-bg.png')); ?>);">
                ...
                <div class="uk-container" data-uk-navbar>
                    <div class="uk-navbar-left">
                        <div class="uk-navbar-item">
                            ...
                            <a class="uk-logo" href="/">
                                <img src="<?php echo e(asset('front/img/axepro-group-logo.png')); ?>" data-src="<?php echo e(asset('front/img/axepro-group-logo.png')); ?>" alt="logo" width="160" height="34" data-uk-img>
                            </a>
                            <!-- logo end -->
                            <!-- navigation begin -->
                                        ...
                                        <div class="uk-navbar-dropdown-grid uk-child-width-1-2" data-uk-grid>
                                            ...
                                            <div>
                                                <ul class="uk-nav uk-navbar-dropdown-nav">
                                                    ...
                                                    <li><a href="<?php echo e(route('calculator')); ?>"><?php echo app('translator')->get('message.ecn_cal'); ?></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li><a href="<?php echo e(route('about')); ?>"><?php echo app('translator')->get('message.company'); ?><i class="fas fa-chevron-down"></i></a>
                                    <div class="uk-navbar-dropdown">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                    ...
                    <div class="uk-navbar-right">
                        <div class="uk-navbar-item uk-visible@m in-optional-nav">
                            <a href="<?php echo e(route('register')); ?>" class="uk-button uk-button-primary uk-border-rounded" style="margin-right: 10px;"><?php echo app('translator')->get('message.crt_acnt'); ?></a>
                            <a href="<?php echo e(route('login')); ?>" class="uk-button uk-button-primary uk-border-rounded"><?php echo app('translator')->get('message.log'); ?> <i class="fas fa-user-circle"></i></a>
                        </div>
                    </div>
                </div>
            </nav>
        ...
        <div class="uk-container">
            <div class="uk-grid">
                <div class="uk-width-1-1">
                    <ul class="uk-breadcrumb"><li><a href="index.html">Home</a></li><li><span><?php echo $__env->yieldContent('title'); ?></span></li></ul>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="uk-container uk-text-small">
                <div class="uk-child-width-1-2@m" data-uk-grid>
                    <div class="in-footer-logo">
                        <img src="<?php echo e(asset('front/img/in-lazy.gif')); ?>" data-src="<?php echo e(asset('front/img/axepro-group-logo.png')); ?>" alt="logo" width="127" height="27" data-uk-img>
                    </div>
                </div>
                <div class="uk-child-width-1-2@s uk-child-width-1-4@m uk-margin-large-top" data-uk-grid>
                    ...
                    <div>
                        ...
                        <ul class="uk-list uk-link-text">
                            <li><a href="<?php echo e(route('webtrader')); ?>">Web Trader</a></li>
                            <li><a href="<?php echo e(route('metatrader')); ?>">MetaTrader 5</a></li>
                        </ul>
                        <div>
                            <h5><?php echo app('translator')->get('message.policies'); ?></h5>
                            <ul class="uk-list uk-link-text">
                                <li><a href="<?php echo e(route('privacy')); ?>"><?php echo app('translator')->get('message.pri_pol'); ?></a></li>
                                <li><a href="<?php echo e(route('terms-of-serv')); ?>"><?php echo app('translator')->get('message.trms'); ?> </a></li>
                                <li><a href="<?php echo e(route('order-execution')); ?>"><?php echo app('translator')->get('message.ordr'); ?> </a></li>
                                <li><a href="<?php echo e(route('risk-disclosure')); ?>"><?php echo app('translator')->get('message.risk_dis'); ?></a></li>
                            </ul>
                        </div>
                    </div>
                    <div>
    ...
    <script src="<?php echo e(asset('front/js/vendors/jquery.min.js')); ?>"></script>
    <?php echo $__env->yieldContent('javascript'); ?>
</body>

</html>
<?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/layouts/auth.blade.php ENDPATH**/ ?>