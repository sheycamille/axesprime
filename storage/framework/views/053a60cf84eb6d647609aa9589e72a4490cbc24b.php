<?php $__env->startSection('title', 'Forex'); ?>

<?php $__env->startSection('forex-menu-item', 'active'); ?>
                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center">
                        <div class="uk-text-center">
                            <h1 class="uk-margin-remove"><?php echo app('translator')->get('message.forex.forex_trading'); ?></h1>
                            <p class="uk-text-lead uk-text-muted uk-margin-small-top"><?php echo app('translator')->get('message.forex.trade_cdf_on'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uk-container">
                <div class="uk-grid-large uk-child-width-1-2@m uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        ...
                        <h3 class="uk-margin-remove"><?php echo app('translator')->get('message.forex.fx_pairs'); ?></h3>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/front/forex.blade.php ENDPATH**/ ?>