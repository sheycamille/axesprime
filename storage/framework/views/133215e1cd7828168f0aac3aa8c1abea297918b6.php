        ...
        <div class="uk-section uk-section-secondary in-liquid-10">
            <div class="uk-container uk-light">
                <div class="uk-grid-medium uk-child-width-1-3@m uk-flex uk-flex-middle uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        <h2><?php echo app('translator')->get('message.why_trade'); ?></h2>
                        <p class="uk-text-lead"><?php echo app('translator')->get('message.why_trade'); ?>?</p>
                        <a class="uk-button uk-button-default uk-border-rounded uk-margin-top" href="#"><?php echo app('translator')->get('message.why_trade'); ?><i class="fas fa-angle-right uk-margin-small-left"></i></a>
                    </div>
                    <div>
                ...
                <div class="uk-grid uk-child-width-1-2@s uk-child-width-1-4@m uk-text-center" data-uk-grid>
                    ...
                    <div>
                        <div class="in-liquid-16-counter">
                            ...
                            <h3 class="uk-text-muted uk-margin-top uk-margin-remove-bottom">
                                <span class="count" data-counter-end="90" data-counter-append=" awards">90+ <?php echo app('translator')->get('message.awards'); ?></span>
                            </h3>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                            <div class="uk-grid uk-flex-middle" data-uk-grid="">
                                ...
                                <div class="uk-width-auto">
                                    <a class="uk-button uk-button-primary uk-border-rounded" href="#"><?php echo app('translator')->get('message.open_acount'); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/front/prod-section.blade.php ENDPATH**/ ?>