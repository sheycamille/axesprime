        ...
        <div class="uk-section uk-section-secondary in-liquid-10">
            <div class="uk-container uk-light">
                <div class="uk-grid-medium uk-child-width-1-3@m uk-flex uk-flex-middle uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        <h2><?php echo app('translator')->get('message.discover'); ?></h2>
                        <p class="uk-text-lead"><?php echo app('translator')->get('message.choose_platform'); ?>?</p>
...
<?php /**PATH C:\laragon\www\axesprime\resources\views/front/prod-section.blade.php ENDPATH**/ ?>