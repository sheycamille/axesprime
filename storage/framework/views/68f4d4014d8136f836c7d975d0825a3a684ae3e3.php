                                ...
                                <table id="ShipTable" class="table table-bordered table-striped table-responsive-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-<?php echo e($text); ?> btn-sm m-1" data-toggle="modal"
                                                ...
                                                <?php else: ?>
                                                <?php if(auth('admin')->user()->hasPermissionTo('mdeposits-process', 'admin')): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/admin/mdeposits.blade.php ENDPATH**/ ?>