                            ...
                            <div class="row">
                                ...
                                <div class="col-9 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-<?php echo e($text); ?>"><?php echo e(\App\Models\Setting::getValue('currency')); ?> <?php echo e(number_format($total_bonus->bonus, 2, '.', ',')); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-<?php echo e($text); ?>"><?php echo e(\App\Models\Setting::getValue('currency')); ?><?php echo e(number_format(Auth::user()->ref_bonus, 2, '.', ',')); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadingaleonardngonga/Downloads/online-trade-06-04-2021/resources/views/user/dashboard.blade.php ENDPATH**/ ?>