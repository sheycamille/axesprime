            ...
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    ...
                    <?php if(Session::has('getAnouc') && Session::get('getAnouc') == 'true'): ?>
                        <?php if(\App\Models\Setting::getValue('enable_annoc') == 'on'): ?>
                            <h5 id="ann" class="text-<?php echo e($text); ?>op-7 mb-4">
                ...
                <div class="d-flex justify-content-stretch flex-row pb-5 pt-5">
                    <div class="col-3 text-center">
                        <a class="btn btn-primary" href="<?php echo e(route('deposits')); ?>">
                            DEPOSITS
                        </a>
                    </div>
                    <div class="col-3 text-center">
                        <a class="btn btn-primary" href="<?php echo e(route('withdrawalsdeposits')); ?>">
                            WITHDRAW FUNDS
                        </a>
                    </div>
                    <div class="col-3 text-center">
                                        ...
                                        <div class="numbers">
                                            ...
                                            <?php $__currentLoopData = $deposited; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposited): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(!empty($deposited->count)): ?>
                                                    <h4 class="card-title text-<?php echo e($text); ?>">
                                                        <?php echo e(\App\Models\Setting::getValue('currency')); ?><?php echo e($deposited->count); ?>

                                                    </h4>
                                                <?php else: ?>
                                                    <h4 class="card-title text-<?php echo e($text); ?>">
                                                        <?php echo e(\App\Models\Setting::getValue('currency')); ?>0.00</h4>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-9 col-stats">
                                        <div class="numbers">
                                            ...
                                            <h4 class="card-title text-<?php echo e($text); ?>">
                                                ...
                                                <?php echo e(number_format($total_bonus, 2, '.', ',')); ?></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
