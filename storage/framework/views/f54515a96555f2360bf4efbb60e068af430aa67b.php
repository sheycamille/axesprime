...
<?php $__env->startSection("add-user", 'active'); ?>
...
<div class="main-panel bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
    <div class="content bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> ">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                <h1 class="title1 text-<?php echo e($text); ?>">Add A New User to <?php echo e(\App\Models\Setting::getValue('site_name')); ?> Community</h1>
            </div>
                ...
                <div class="col-lg-8 offset-lg-2 card p-3 bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> shadow">
                    <form method="POST" action="<?php echo e(url('admin/dashboard/saveuser')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            <h4 class="text-<?php echo e($text); ?>">FullName</h4>
                            <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadingaleonardngonga/Documents/Projects/axesprime/resources/views/admin/referuser.blade.php ENDPATH**/ ?>