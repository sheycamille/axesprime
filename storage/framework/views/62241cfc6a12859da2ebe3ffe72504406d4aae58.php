    ...
    <div class="main-panel bg-<?php echo e($bg); ?>">
        <div class="content bg-<?php echo e($bg); ?>">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h1 class="title1 text-<?php echo e($text); ?> text-center">Request for Withdrawal</h1>
                </div>
                    ...
                    <?php $__currentLoopData = $wmethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 p-3 rounded card bg-<?php echo e($bg); ?>">
                            <div class="shadow card-body border-danger">
                                ...
                                <h4 class="text-<?php echo e($text); ?>">Minimum amount: <strong style="float:right;">
                                        <?php echo e(\App\Models\Setting::getValue('currency')); ?><?php echo e($method->minimum); ?></strong>
                                </h4>
                                <br>

                                <h4 class="text-<?php echo e($text); ?>">Maximum amount:<strong style="float:right;">
                                        <?php echo e(\App\Models\Setting::getValue('currency')); ?><?php echo e($method->maximum); ?></strong>
                                </h4><br>

                                <h4 class="text-<?php echo e($text); ?>">Charges (Fixed):<strong style="float:right;">
                                        <?php echo e(\App\Models\Setting::getValue('currency')); ?><?php echo e($method->charges_fixed); ?></strong>
                                </h4><br>

                                <h4 class="text-<?php echo e($text); ?>">Charges (%): <strong style="float:right;">
                                        <?php echo e($method->charges_percentage); ?>%</strong></h4><br>

                                <h4 class="text-<?php echo e($text); ?>">Duration:<strong style="float:right;">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header bg-<?php echo e($bg); ?>">
                                        <h4 class="modal-title text-<?php echo e($text); ?>">Payment will be sent through your
                                            selected method.</h4>
                                    ...
                                    <div class="modal-body bg-<?php echo e($bg); ?>">
                                        <form style="padding:3px;" role="form" method="post"
                                            ...
                                            <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>"
                                                placeholder="Enter amount here" type="text" name="amount" required><br />
                                            <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?> "
                                                value="<?php echo e($method->name); ?>" type="text" disabled><br />
                                            <select required
                ...
                <div id="withdrawdisabled" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body bg-<?php echo e($bg); ?>">
                                <h4 class="text-<?php echo e($text); ?>">Withdrawal is Disabled at this time, Please contact
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadingaleonardngonga/Documents/Projects/axesprime/resources/views/user/mwithdrawal.blade.php ENDPATH**/ ?>