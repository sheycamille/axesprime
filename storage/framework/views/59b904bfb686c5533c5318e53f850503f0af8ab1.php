...
<?php $__env->startSection('products-menu-item', 'active'); ?>
...
<main id="main" class="about-us-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="text-left">
                        <a class="btn-get-started" href="<?php echo e(route('register')); ?>">Start Trading Forex</a><br>
                    </div>
                </div>
                <img class="col-md-4" src="<?php echo e(asset ('front/img/about/Forex_1.png')); ?>" alt="Forex" tilte="Forex" />
            </div>
        </div>
    </section>
    ...
    <section id="getstarted" class="section-bg wow fadeInUp">
        <div class="container">
            <div class="row">
                <img class="col-md-4" src="<?php echo e(asset ('front/img/about/ETFs_1.png')); ?>" alt="ETFs" tilte="ETFs" />
                <div class="col-md-8">
                    <div class="section-header">
                    ...
                    <div class="text-right">
                        <a class="btn-get-started mr-auto" href="<?php echo e(route('register')); ?>">Start Trading ETFs</a><br>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="text-left">
                        <a class="btn-get-started" href="<?php echo e(route('register')); ?>">Start Trading Commodities</a><br>
                    </div>
                </div>
                <img class="col-md-4" src="<?php echo e(asset ('front/img/about/Commodities_1.png')); ?>" alt="Commodities" tilte="Commodities" />
            </div>
        </div>
    </section>
    ...
    <section id="getstarted" class="section-bg wow fadeInUp">
        <div class="container">
            <div class="row">
                <img class="col-md-4" src="<?php echo e(asset ('front/img/about/Shares_1.png')); ?>" alt="Shares" tilte="Shares" />
                <div class="col-md-8">
                    <div class="section-header">
                    ...
                    <div class="text-right">
                        <a class="btn-get-started mr-auto" href="<?php echo e(route('register')); ?>">Start Trading Shares</a><br>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="text-left">
                        <a class="btn-get-started" href="<?php echo e(route('register')); ?>">Start Trading Indices</a><br>
                    </div>
                </div>
                <img class="col-md-4" src="<?php echo e(asset ('front/img/about/Indices_1.png')); ?>" alt="Indices" tilte="Indices" />
            </div>
        </div>
    </section>
    ...
    <section id="getstarted" class="section-bg wow fadeInUp">
        <div class="container">
            <div class="row">
                <img class="col-md-4" src="<?php echo e(asset ('front/img/about/Cryptos_1.png')); ?>" alt="Cryptocurrency" tilte="Cryptocurrency" />
                <div class="col-md-8">
                    <div class="section-header">
                    ...
                    <div class="text-right">
                        <a class="btn-get-started" href="<?php echo e(route('register')); ?>">Start Trading Cryptocurrency</a><br>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadingaleonardngonga/Documents/Projects/axesprime/resources/views/front/products.blade.php ENDPATH**/ ?>