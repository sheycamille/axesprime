<?php $__env->startSection('title', 'PayStudio Payment'); ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col card p-2 d-flex justify-content-center">
                                        ...
                                        <div class="card shadow">
                                            <div class="card-body">
                                                <div id="paystudio" class="d-flex justify-content-center col-xs-12">
                                                    <form method="post" action="<?php echo e(route('startpaystudiocharge')); ?>"
                                                        ...
                                                        <div class="form-group d-flex justify-content-center col-xs-12">
                                                            ...
                                                            <div class="col-md-3" style="display: inline-block;">
                                                                ...
                                                                <select class="form-control" name="country" id="country"
                                                                    ...
                                                                    <option <?php if(Auth::user()->country == $code ||
                                                                        Auth::user()->country == $name): ?> selected <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/user/paystudio.blade.php ENDPATH**/ ?>