                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <select name="state" id="state" class="form-control"
                                                                ...
                                                                <option disabled><?php echo app('translator')->get('message.register.enter_stt'); ?>
                                                                </option>
                                                                <?php if(Auth::user()->state_id != ""): ?>
                                                                <option selected value="<?php echo e(Auth::user()->state->id); ?>">
                                                                    <?php echo e(Auth::user()->state->name); ?>
                                                        ...
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <select name="town" id="town" class="form-control"
                                                                ...
                                                                <?php if(Auth::user()->town_id != ""): ?>
                                                                <option selected value="<?php echo e(Auth::user()->town->id); ?>">
                                                                    <?php echo e(Auth::user()->town->name); ?>
