                                ...
                                <div id="method<?php echo e($method->id); ?>" class="panel-collapse collapse">
                                    <div class="sign-u">
                                        ...
                                        <a class="btn btn-danger btn-sm"
                                            href="<?php echo e(route('deletewdmethod', $method->id)); ?>">
                                            Delete
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="post" action="<?php echo e(route('updatewdmethod')); ?>"
                                                ...
                                                <textarea class="form-control" name="details" row="3"
                                                    ...
                                                    cols="20"><?php echo $method->details; ?></textarea>
                                                <br />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php if($method->logo): ?>
                                                    <img width="150px"
                                                        src="<?php echo e(asset('storage/logos/' . $method->logo)); ?>">
                                                    <?php endif; ?>
                                                </div><br />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadingaleonardngonga/Documents/Projects/axesprime/resources/views/admin/paysettings.blade.php ENDPATH**/ ?>