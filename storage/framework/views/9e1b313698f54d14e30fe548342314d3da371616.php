    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add Trading History for <?php echo e($user->name); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form style="padding:3px;" role="form" method="post" action="<?php echo e(route('edituser')); ?>">
                    ...
                    <input style="padding:5px;" class="form-control" value="<?php echo e($user->name); ?>" type="text" name="name"
                        required><br />
                    <h5 class="">Email</h5>
                    <input style="padding:5px;" class="form-control" value="<?php echo e($user->email); ?>" type="text" name="email"
                        required><br />
                    <h5 class="">Phone Number</h5>
                    <input style="padding:5px;" class="form-control" value="<?php echo e($user->phone); ?>" type="text" name="phone"
                        required><br />
...
<div id="resetpswdModal<?php echo e($user->id); ?>" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="">Are you sure you want to reset password for <?php echo e($user->name); ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a class="btn btn-primary" href="<?php echo e(url('admin/dashboard/clearacct')); ?>/<?php echo e($user->id); ?>">Proceed</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-3">
                ...
                <a class="btn btn-danger" href="<?php echo e(url('admin/dashboard/delsystemuser')); ?>/<?php echo e($user->id); ?>">Yes i'm
                    sure</a>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                <div class="accountstable table table-hover">
                    ...
                    <div class="row">
                        ...
                        <div class="cell">
                            <a href="<?php echo e(route('dellaccounts', $acc->id)); ?>" class="m-1 btn btn-danger btn-xs">Delete
                                Account</a>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
