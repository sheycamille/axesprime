...
<?php $__env->startSection('calender-menu-item', 'uk-active'); ?>
                    ...
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center"
                        ...
                        <div class="uk-text-center uk-margin-medium-top">
                            <a class="uk-button uk-button-primary uk-border-rounded uk-margin-small-right"
                                href="#"><?php echo app('translator')->get('message.creat_account'); ?><i class="fas fa-angle-right uk-margin-small-left"></i></a>
                            <a class="uk-button uk-button-secondary uk-border-rounded" href="#"><?php echo app('translator')->get('message.discover'); ?><i
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\axesprime\resources\views/front/economic-calender.blade.php ENDPATH**/ ?>