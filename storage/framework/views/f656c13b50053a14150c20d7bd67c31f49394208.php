...
<head>
    ...
    <meta name="description" content="<?php echo e(\App\Models\Setting::getValue('site_description')); ?>">
    <meta name="keywords" content="<?php echo e(\App\Models\Setting::getValue('keywords')); ?>">
...
<body>
    ...
    <header>
        ...
        <div class="uk-section uk-padding-remove-vertical in-header-inner uk-background-cover uk-background-top-center"
            style="background-image: url(<?php echo e(asset('front/img/in-liquid-slide-bg.png')); ?>);">
                ...
                <div class="uk-container" data-uk-navbar>
                            ...
                            <ul class="uk-navbar-nav uk-visible@m">
                                        ...
                                        <div class="uk-navbar-dropdown-grid uk-child-width-1-2" data-uk-grid>
                                            <div>
                                                <ul class="uk-nav uk-navbar-dropdown-nav">
                                                    ...
                                                    <li><a href="<?php echo e(route('metatrader')); ?>"><?php echo app('translator')->get('message.mtd'); ?></a>
                                                    </li>
                                                    <br>
                                                    <br>
                                                    <li>
                                ...
                                <li>
                                    <a href="<?php echo e(route('about')); ?>">
                                        <?php echo app('translator')->get('message.company'); ?><i class="fas fa-chevron-down"></i>
                                    </a>
                                    <div class="uk-navbar-dropdown">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                    ...
                    <div class="uk-navbar-right">
                        <div class="uk-navbar-item uk-visible@m in-optional-nav">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="uk-button uk-button-primary uk-border-rounded">
                                <?php echo app('translator')->get('message.log'); ?> <i class="fas fa-user-circle"></i>
                            </a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/layouts/front.blade.php ENDPATH**/ ?>