...
<div class="main-panel">
    <div class="content bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                <h1 class="title1 text-<?php echo e($text); ?>">Clients Withdrawals</h1>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                    <a class="m-1 btn btn-primary btn-sm" href="<?php echo e(url('admin/dashboard/pwithdrawal')); ?>/<?php echo e($deposit->id); ?>">Process</a>
                                    <?php endif; ?>
                                    <a href="#" class="m-1 btn btn-info btn-sm" data-toggle="modal" data-target="#viewModal<?php echo e($deposit->id); ?>"><i class="fa fa-eye"></i> View</a>

                                    <a class="m-1 btn btn-primary btn-sm" data-toggle="modal" data-target="#rejctModal<?php echo e($deposit->id); ?>" href="#">Reject</a>
                                </td>
                            </tr>
                            <!-- View info modal-->
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> ">
                                            <h4 class="modal-title text-<?php echo e($text); ?>">Reason For Rejection.</strong></h4>
                                        ...
                                        <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                                            <form action="<?php echo e(route('rejectwithdrawal')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <textarea class="bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?> mb-2 form-control" row="3" placeholder="Type in here" name="reason"></textarea>
