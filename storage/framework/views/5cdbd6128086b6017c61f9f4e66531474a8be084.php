...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('.yajra-datatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "<?php echo e(route('fetchacctypes')); ?>",
          columns: [
              {data: 'id', name: 'id'},
              {data: 'name', name: 'name'},
              {data: 'forex_pairs', name: 'forex_pairs'},
              {data: 'comodities',name: 'comodities'},
              {data: 'indices',name: 'indices'},
              {data: 'cost',name: 'cost'},
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\axesprime\resources\views/admin/accounttypes.blade.php ENDPATH**/ ?>