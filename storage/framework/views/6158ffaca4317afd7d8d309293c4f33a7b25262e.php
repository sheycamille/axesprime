    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body bg-<?php echo e($bg); ?>">
                <form style="padding:3px;" role="form" method="post" action="<?php echo e(route('newdeposit')); ?>">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body bg-<?php echo e($bg); ?> p-3">
                <h5 class="text-<?php echo e($text); ?>">Your subscription has already started, send an Email to <?php echo e(\App\Models\Setting::getValue('contact_email')); ?> to have your MT4 Details Deleted.</h5>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="SubpayModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form role="form" method="post" action="<?php echo e(route('newdeposit')); ?>" id="priceform">
                <div class="modal-body bg-<?php echo e($bg); ?>">
...
<!-- /plans Modal -->
<?php /**PATH /Users/wadingaleonardngonga/Downloads/online-trade-06-04-2021/resources/views/user/modals.blade.php ENDPATH**/ ?>