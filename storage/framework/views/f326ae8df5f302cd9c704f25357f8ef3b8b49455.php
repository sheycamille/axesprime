...
<main id="main" class="about-us-page">
        ...
        <div class="uk-section uk-padding-remove-vertical">
            <div class="about uk-light in-slideshow uk-background-cover uk-background-top-center" style="background-image: url(<?php echo e(asset('front/img/in-liquid-slide-bg.png')); ?>);" data-uk-slideshow>
                            ...
                            <div class="uk-grid-medium" data-uk-grid>
                                <div class="uk-width-1-2@s">
                                    <div class="uk-overlay">
                                        <h1><?php echo app('translator')->get('message.about.about_pt1'); ?><br><?php echo app('translator')->get('message.about.about_pt2'); ?></h1>
                                        <p class="uk-text-lead uk-visible@m" style="font-size: 17px;" >
                                        <?php echo app('translator')->get('message.about.fsa'); ?>
                                        </p>
                                    </div>
                                </div>
                                <div class="uk-width-1-2@s">
                ...
                <div class="uk-grid">
                    <div class="uk-width-1-1 uk-flex uk-flex-center">
                        <div class="uk-width-3-4@m uk-text-center">
                            <h2 class="uk-margin-small-bottom"><?php echo app('translator')->get('message.about.our_clients_first'); ?> <span class="in-highlight"><?php echo app('translator')->get('message.about.since'); ?>.</span></h2>
                            <p class="uk-text-lead uk-text-muted uk-margin-remove"><?php echo app('translator')->get('message.about.empowering_clients'); ?>.</p>
                        </div>
            ...
            <div class="uk-grid-medium uk-child-width-1-1 uk-child-width-1-3@m" data-uk-grid>
                    ...
                    <div class="in-timeline-branch">
                        <div class="uk-flex">
                            ...
                            <div class="in-timeline-title uk-flex uk-flex-middle">
                                <h4 class="uk-margin-remove-bottom"><?php echo app('translator')->get('message.about.strategy'); ?></h4>
                    ...
                    <div class="uk-box-shadow-small uk-width-expand">
                     <div class="uk-card uk-card-default uk-card-body uk-card-small uk-border-rounded">
                            <ul class="uk-list uk-list-bullet in-list-check">
                                <p><?php echo app('translator')->get('message.about.aim'); ?></p>
                                <li><?php echo app('translator')->get('message.about.ultra_fast'); ?></li>
                                <li><?php echo app('translator')->get('message.about.aggregation'); ?></li>
                                <li><?php echo app('translator')->get('message.about.research'); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="in-timeline-branch">
                        <div class="uk-flex">
                         <div class="in-timeline-title uk-flex uk-flex-middle">
                                <h4 class="uk-margin-remove-bottom"><?php echo app('translator')->get('message.about.vision'); ?></h4>
                           </div>
                        </div>
                    </div>
                    <div class="uk-box-shadow-small uk-width-expand">
                        <div class="uk-card uk-card-default uk-card-body uk-card-small uk-border-rounded">
                            <ul class="uk-list uk-list-bullet in-list-check">
                                <p _ngcontent-ng-cli-universal-c113=""><?php echo app('translator')->get('message.about.approach'); ?>.</p>
                                <li><?php echo app('translator')->get('message.about.accessible_trading'); ?></li>
                                <li><?php echo app('translator')->get('message.about.constant_refinement'); ?></li>
                                <li><?php echo app('translator')->get('message.about.ethical'); ?>.</li>
                ...
                <div>
                    <div class="in-timeline-branch">
                        <div class="uk-flex">
                            ...
                            <div class="in-timeline-title uk-flex uk-flex-middle">
                                <h4 class="uk-margin-remove-bottom"><?php echo app('translator')->get('message.about.values'); ?></h4>
                    ...
                    <div class="uk-box-shadow-small uk-width-expand">
                        <div class="uk-card uk-card-default uk-card-body uk-card-small uk-border-rounded">
                            <ul class="uk-list uk-list-bullet in-list-check uk">
                                <p _ngcontent-ng-cli-universal-c113=""><?php echo app('translator')->get('message.about.commited'); ?>.</p>
                                <li><?php echo app('translator')->get('message.about.unwavering'); ?></li>
                                <li><?php echo app('translator')->get('message.about.investment_research'); ?></li>

                                <li><?php echo app('translator')->get('message.about.business_model'); ?>  </li>
                        ...
                        <div class="uk-grid-small uk-child-width-1-2@s uk-child-width-1-3@m uk-margin-medium-top" data-uk-grid>
                            ...
                            <div>
                                <div class="uk-card uk-card-secondary uk-card-body uk-border-rounded">
                                    <div class="uk-flex uk-flex-middle">
                                        ...
                                        <div>
                                            <h6 class="uk-margin-remove"><?php echo app('translator')->get('message.metals'); ?></h6>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <div class="uk-card uk-card-secondary uk-card-body uk-border-rounded">
                                    <div class="uk-flex uk-flex-middle">
                                        ...
                                        <div>
                                            <h6 class="uk-margin-remove"><?php echo app('translator')->get('message.shares'); ?></h6>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <div class="uk-card uk-card-secondary uk-card-body uk-border-rounded">
                                    ...
                                    <p><?php echo app('translator')->get('message.trade_bitcoin'); ?></p>
                                    <a href="#" class="uk-button uk-button-text uk-margin-small-top"><?php echo app('translator')->get('message.read_more'); ?><i class="fas fa-angle-right uk-margin-small-left"></i></a>
                                </div>
                            </div>
                            <div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/front/about.blade.php ENDPATH**/ ?>