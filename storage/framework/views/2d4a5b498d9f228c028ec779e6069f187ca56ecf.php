        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col p-4">
                            <a href="<?php echo e(url('/admin/dashboard/addadmin')); ?>" 
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex justify-content-start">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink"
                                                            style="z-index: 999;">
                                                            <?php if(auth('admin')->user()->hasPermissionTo('madmin-block', 'admin')): ?>
                                                        ...
                                                        <?php if(auth('admin')->user()->hasPermissionTo('madmin-delete', 'admin')): ?>
                                                        <a href="#" data-toggle="modal"
                                                        data-target="#deleteModal<?php echo e($admin->id); ?>"
                                                        class="m-1 btn btn-danger btn-sm">Delete</a>
                                                        <?php endif; ?>
                                                        <?php if(auth('admin')->user()->hasPermissionTo('madmin-edit', 'admin')): ?>
                                                        <a href="#" data-toggle="modal"
                                                    ...
                                                    <div class="modal-body">
                                                        <form style="padding:3px;" role="form" method="post"
                                                            ...
                                                            <select class="form-control " name="type">
                                                                <option <?php if($admin->type == "Super Admin"): ?> selected <?php endif; ?> value="Super Admin">Super Admin</option>
                                                                <option <?php if($admin->type == "Admin"): ?> selected <?php endif; ?> value="Admin">Admin</option>
                                                            </select><br>
                                                            <h5 class=" ">Roles</h5>
                                                            <select class="form-control" name="roles[]" multiple>  
                                                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option <?php if($admin->hasRole($role)): ?> selected <?php endif; ?> value="<?php echo e($role->id); ?>"><?php echo e($role->name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>         
                                                            </select>
                                                            <br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/admin/madmins.blade.php ENDPATH**/ ?>