...
<div class="main-panel bg-<?php echo e($bg); ?>">
    <div class="content bg-<?php echo e($bg); ?>">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                <h1 class="text-<?php echo e($text); ?>">Add Withdrawal Info</h1>
            </div>
            ...
            <div class="mb-4 row">
                <div class="col card p-3 shadow-lg bg-<?php echo e($bg); ?>">
                    <div class="accordion accordion-<?php echo e($text); ?> ">
                        <form method="post" action="<?php echo e(route('updateacount')); ?>">
                            <!--............................... collapse one -->
                            <div class="card">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadingaleonardngonga/Documents/Projects/axesprime/resources/views/user/updateacct.blade.php ENDPATH**/ ?>