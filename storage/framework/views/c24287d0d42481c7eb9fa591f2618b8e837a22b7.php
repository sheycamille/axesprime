        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                        ...
                        <input style="padding:5px;" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e($user->name); ?>" type="text" disabled><br/>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                    <form style="padding:3px;" role="form" method="post" action="<?php echo e(route('edituser')); ?>">
                        ...
                        <input style="padding:5px;" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e($user->name); ?>" type="text" name="name" required><br/>
                        <h5 class=" text-<?php echo e($text); ?>">Email</h5>
                        <input style="padding:5px;" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e($user->email); ?>" type="text" name="email" required><br/>
                        <h5 class=" text-<?php echo e($text); ?>">Phone Number</h5>
                        <input style="padding:5px;" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e($user->phone); ?>" type="text" name="phone" required><br/>
                        <h5 class=" text-<?php echo e($text); ?>">Referral link</h5>
                        <input style="padding:5px;" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e($user->ref_link); ?>" type="text" name="ref_link" required><br/>
                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                        <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
    ...
    <div id="resetpswdModal<?php echo e($user->id); ?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                    <p class="text-<?php echo e($text); ?>">Are you sure you want to reset password for <?php echo e($user->name); ?> <?php echo e($user->l_name); ?> to <span class="text-primary font-weight-bolder">user01236</span></p>
    ...
    <div id="switchuserModal<?php echo e($user->id); ?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                    <a class="btn btn-<?php echo e($text); ?>" href="<?php echo e(url('admin/dashboard/switchuser')); ?>/<?php echo e($user->id); ?>">Proceed</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> p-3">
                    <p class="text-<?php echo e($text); ?>">Are you sure you want to delete <?php echo e($user->name); ?> <?php echo e($user->l_name); ?></p>
