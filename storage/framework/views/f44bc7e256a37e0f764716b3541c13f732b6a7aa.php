    ...
    <div class="main-panel bg-<?php echo e($bg); ?>">
        <div class="content bg-<?php echo e($bg); ?>">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h1 class="title1 text-<?php echo e($text); ?> text-center">My Withdrawals</h1>
                </div>
                ...
                <div class="row py-3 mb-4">
                    <div class="col">
                        ...
                        <a class="btn btn-primary" href="<?php echo e(route('mwithdrawal')); ?>"><i class="fa fa-plus"></i> New
                            Withdrawal</a>
                    </div>
                </div>
                <div class="row mb-5">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadingaleonardngonga/Documents/Projects/axesprime/resources/views/user/withdrawals.blade.php ENDPATH**/ ?>