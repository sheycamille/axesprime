                        ...
                        <form method="POST" action="<?php echo e(route('register')); ?>" class="mt-5 card__form">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="mr-2 form-control" name="first_name" value="<?php echo e(old('first_name')); ?>"
                                        id="first_name" placeholder="<?php echo app('translator')->get('message.first_name'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="mr-2 form-control" name="last_name" value="<?php echo e(old('last_name')); ?>"
                                        id="last_name" placeholder="<?php echo app('translator')->get('message.last_name'); ?>">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\axesprime\resources\views/auth/register.blade.php ENDPATH**/ ?>