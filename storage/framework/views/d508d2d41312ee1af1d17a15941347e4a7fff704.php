                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <h3 class="">Check your email with the
                                                            KYC upload that has an attachment name of
                                                            <span class="text-danger"><?php echo e($user->id_card_back); ?></span>
                                                        </h3>
                                                        <?php elseif(\App\Models\Setting::getValue('location') == "Local"): ?>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <h3 class="">Check your email with the
                                                            KYC upload that has an attachment name of
                                                            <span class="text-danger"><?php echo e($user->address_document); ?></span>
                                                        </h3>
                                                        <?php elseif(\App\Models\Setting::getValue('location') == "S3"): ?>
                                                        <?php
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/admin/kyc.blade.php ENDPATH**/ ?>