...
<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    ...
    <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="<?php echo e(url('/dashboard')); ?>">
        ...
        <li class="c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('my-profile'); ?>" href="<?php echo e(url('dashboard/profile')); ?>">
                    <?php echo app('translator')->get('message.dashboard.my_pfl'); ?>
                    </a>
                </li>
                <?php if(\App\Models\Setting::getValue('enable_kyc') == 'yes'): ?>
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('kyc'); ?>" href="<?php echo e(url('dashboard/verify-account')); ?>">
                ...
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('security'); ?>"
                        href="<?php echo e(url('dashboard/manage-account-security')); ?>">
                ...
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('withdrawal-info'); ?>"
                        href="<?php echo e(url('dashboard/withdrawaldetails')); ?>">
                        <span class="sub-item"><?php echo app('translator')->get('message.dashboard.with_info'); ?></span>
                    </a>
                </li>
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('notifications'); ?>" href="<?php echo e(url('dashboard/notifications')); ?>">
        ...
        <li class="c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('live-accounts'); ?>" href="/dashboard/live-accounts">
                        <span class="sub-item"><?php echo app('translator')->get('message.dashboard.live'); ?></span>
                    </a>
                </li>
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('demo-accounts'); ?>" href="/dashboard/demo-accounts">
        ...
        <li class="c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('deposits'); ?>" href="<?php echo e(url('dashboard/deposits')); ?>">
                        <span class="sub-item"><?php echo app('translator')->get('message.dashboard.depo'); ?></span>
                    </a>
                </li>
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('withdrawals'); ?>" href="<?php echo e(url('dashboard/withdrawals')); ?>">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('downloads'); ?>" href="<?php echo e(url('dashboard/downloads')); ?>">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link <?php echo $__env->yieldContent('support'); ?>" href="<?php echo e(url('dashboard/support')); ?>">
...
<?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/user/sidebar.blade.php ENDPATH**/ ?>