    ...
    <ul class="c-header-nav ml-auto mr-4">
        ...
        <li class="c-header-nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right pt-0">
                <a class="dropdown-item" href="<?php echo e(route('changepassword')); ?>"><?php echo app('translator')->get('message.topmenu.chg_pss'); ?></a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo e(route('account.profile')); ?>"><?php echo app('translator')->get('message.dashboard.my_pfl'); ?></a>
                <div class="dropdown-divider"></div>
...
<?php /**PATH C:\laragon\www\axesprime\resources\views/user/topmenu.blade.php ENDPATH**/ ?>