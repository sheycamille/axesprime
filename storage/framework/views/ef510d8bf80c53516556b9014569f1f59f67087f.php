<?php $__env->startSection('title', 'Trade CFDs on Energies'); ?>

<?php $__env->startSection('energies-menu-item', 'active'); ?>

<?php $__env->startSection('content'); ?>
<main id="main" class="energies-page">
                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center">
                        <div class="uk-text-center">
                            <h1 class="uk-margin-remove">Trade CFDs on Energies</h1>
                            <p class="uk-text-lead uk-text-muted uk-margin-small-top">Trade CFDs on Spot Energies such as Brent oil, WTI and Natural Gas and diversify your portfolio.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uk-container">
                <div class="uk-grid-large uk-child-width-1-2@m uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        ...
                        <h3 class="uk-margin-remove">Invest in some of the most popular spot energies such as Brent and WTI.</h3>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/front/energies.blade.php ENDPATH**/ ?>