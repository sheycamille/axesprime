                ...
                <div class="col card p-3 bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                    ...
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> card p-3" id="1" role="tabpanel" aria-labelledby="nav-home-tab">
                            <?php echo $__env->make('admin.includes.webinfo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        ...
                        <div class="tab-pane fade p-3 bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>" id="2" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <?php echo $__env->make('admin.includes.websettings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadingaleonardngonga/Downloads/online-trade-06-04-2021/resources/views/admin/settings.blade.php ENDPATH**/ ?>