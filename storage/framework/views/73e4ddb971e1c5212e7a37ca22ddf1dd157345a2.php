    ...
    <div class="main-panel bg-<?php echo e($bg); ?>">
        <div class="content bg-<?php echo e($bg); ?>">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h1 class="title1 text-<?php echo e($text); ?> text-center">My Transactions</h1>
                </div>
                ...
                <div class="mb-5 row">
                    <div class="col text-center card p-4 bg-<?php echo e($bg); ?>">
                        ...
                        <div class="px-3 py-3 tab-content px-sm-0" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active bg-<?php echo e($bg); ?> card p-3" id="1" role="tabpanel"
                            ...
                            <div class="tab-pane fade p-3 bg-<?php echo e($bg); ?>" id="2" role="tabpanel"
