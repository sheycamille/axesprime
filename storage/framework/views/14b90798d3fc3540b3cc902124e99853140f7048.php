...
<?php $__env->startSection('metals-menu-item', 'uk-active'); ?>
                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center">
                        <div class="uk-text-center">
                            <h1 class="uk-margin-remove"><?php echo app('translator')->get('message.metals.precious_metals'); ?></h1>
                            <p class="uk-text-lead uk-text-muted uk-margin-small-top"><?php echo app('translator')->get('message.metals.trade_on_metals'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uk-container">
                <div class="uk-grid-large uk-child-width-1-2@m uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        ...
                        <h3 class="uk-margin-remove"><?php echo app('translator')->get('message.metals.ndd'); ?>.</h3>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\axesprime\resources\views/front/metals.blade.php ENDPATH**/ ?>