<?php $__env->startComponent('mail::layout'); ?>
    ...
    <?php $__env->slot('header'); ?>
        <?php $__env->startComponent('mail::header', ['url' => config('app.url')]); ?>
            <img src="<?php echo e(asset('front/img/ap-logo-email.png')); ?>" alt="<?php echo e(config('app.name')); ?>" style="width: 200px"
                class="text-center">
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH /Users/wadingaleonardngonga/Documents/Projects/axesprime/resources/views/vendor/mail/html/message.blade.php ENDPATH**/ ?>