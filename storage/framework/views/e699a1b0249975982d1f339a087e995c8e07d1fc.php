        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="<?php echo e(url('/admin/dashboard/createrole')); ?>" 
                        ...
                        <div class="col p-4">
                            <div class="table-responsive" data-example-id="hoverable-table">
                                <table id="ShipTable" class="table table-bordered table-striped table-responsive-sm">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $permission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e(++$i); ?></td>
                                            <td><?php echo e($value->name); ?></td>             
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    <!--<a href="<?php echo e(route('editrole', $value->id)); ?>" class="m-1 btn btn-secondary btn-sm">Edit</a>-->
                                                    <a href="#" data-toggle="modal"
                                                    data-target="#deleteModal<?php echo e($value->id); ?>"
                                        ...
                                        <div id="deleteModal<?php echo e($value->id); ?>" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body p-3">
                                                        <form action="<?php echo e(route('deleteperm', $value->id)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body p-3">
                                                        <form style="" role="form" method="post"
                                                            action="<?php echo e(route('createperm')); ?>">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/admin/perms/index.blade.php ENDPATH**/ ?>