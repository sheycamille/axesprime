...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('content'); ?> 
        ...
        <h3 class="text-lg font-medium text-<?php echo e($text); ?>">
            <?php if($this->enabled): ?>
        ...
        <div class="max-w-xl mt-3 text-sm text-<?php echo e($text); ?>">
        ...
        <?php if($this->enabled): ?>
            <?php if($showingQrCode): ?>
                <div class="max-w-xl mt-4 text-sm text-<?php echo e($text); ?>">
            ...
            <?php if($showingRecoveryCodes): ?>
                <div class="max-w-xl mt-4 text-sm text-<?php echo e($text); ?>">
                    <p class="font-semibold text-<?php echo e($text); ?>">
                ...
                <div class="grid max-w-xl gap-1 px-4 py-4 mt-4 font-mono text-sm bg-<?php echo e($bg); ?> rounded-lg">
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH /Users/wadingaleonardngonga/Downloads/online-trade-06-04-2021/resources/views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>