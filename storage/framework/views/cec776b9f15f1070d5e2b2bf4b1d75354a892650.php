        ...
        <div style="width:100%;padding:250px auto;background-color:#ffffff;">
            ...
            <div style="font-size:0;text-align:center padding-bottom: 50px;">
                ...
                <div style="width:100%;max-width:300px;display:inline-block;vertical-align:top;height:100px">
                    ...
                    <a style="text-align:center;" href="<?php echo e(asset('downloads/axesprimeltd5setup.exe')); ?>">
                ...
                <div style="width:100%;max-width:300px;display:inline-block;vertical-align:top;height:100px">
                    ...
                    <a style="text-align:center;"
                        ...
                        <img class="" src="<?php echo e(asset('front/img/about/google_play_badge.png')); ?>"
                ...
                <div style="width:100%;max-width:300px;display:inline-block;vertical-align:top;height:100px">
                    ...
                    <a style="text-align:center;"
                        ...
                        target="_blank">
                        <img src="<?php echo e(asset('front/img/about/app-store-en.png')); ?>" alt="iPhone Download"
...
<?php /**PATH /Users/wadingaleonardngonga/Documents/Projects/axesprime/resources/views/vendor/mail/html/footer.blade.php ENDPATH**/ ?>