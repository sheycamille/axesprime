                        ...
                        <form method="POST" action="<?php echo e(route('register')); ?>" class="mt-5 card__form">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="mr-2 form-control" name="name" value="<?php echo e(old('name')); ?>" id="f_name" placeholder="Enter FullName">
                                </div>
                            ...
                            <div class="mb-3 text-center">
                                <small class="mb-2 text-center ">Already have an Account <a href="<?php echo e(route('login')); ?>">Login.</a> </small>
...
<?php /**PATH /Users/wadingaleonardngonga/Downloads/online-trade-06-04-2021/resources/views/auth/register.blade.php ENDPATH**/ ?>