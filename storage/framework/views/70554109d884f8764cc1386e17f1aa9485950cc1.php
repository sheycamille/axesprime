<?php $__env->startSection('title', 'Precious Metals'); ?>

<?php $__env->startSection('metals-menu-item', 'active'); ?>

<?php $__env->startSection('content'); ?>
<main id="main" class="metals-page">
                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center">
                        <div class="uk-text-center">
                            <h1 class="uk-margin-remove">Precious Metals Trading</h1>
                            <p class="uk-text-lead uk-text-muted uk-margin-small-top">Trade CFDs on Spot Metals and unmask new trading opportunities</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uk-container">
                <div class="uk-grid-large uk-child-width-1-2@m uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        ...
                        <h3 class="uk-margin-remove">All client trades are executed with No Dealing Desk1 intervention. Most trades are filled in under 14 milliseconds, with up to 2,400 trades executed per second.</h3>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wadleo/Documents/Projects/axeprogroup/axepro/resources/views/front/metals.blade.php ENDPATH**/ ?>