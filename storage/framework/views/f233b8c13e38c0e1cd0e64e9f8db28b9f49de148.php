                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item active">
                            <div class="carousel-background"><img
                                    src="<?php echo e(asset('storage/photos/' . $content->getImage('57VnOE', 'img_path'))); ?>"
                                    alt="">
                            </div>
                        ...
                        <div class="carousel-item">
                            <div class="carousel-background"><img
                                    src="<?php echo e(asset('storage/photos/' . $content->getImage('dC6ZaA', 'img_path'))); ?>"
                                    alt="">
                            </div>
                            <div class="carousel-container">
                                <div class="carousel-content">
                        ...
                        <div class="carousel-item">
                            <div class="carousel-background"><img
                                    src="<?php echo e(asset('storage/photos/' . $content->getImage('9kHash', 'img_path'))); ?>"
                                    alt="">
                                <div class="carousel-container">
                                    <div class="carousel-content">
                        ...
                        <div class="carousel-item">
                            <div class="carousel-background"><img
                                    src="<?php echo e(asset('storage/photos/' . $content->getImage('CcW52g', 'img_path'))); ?>"
                                    alt="">
                            </div>
                            <div class="carousel-container">
                                <div class="carousel-content">
                        ...
                        <div class="carousel-item">
                            <div class="carousel-background"><img
                                    src="<?php echo e(asset('storage/photos/' . $content->getImage('96i7xH', 'img_path'))); ?>"
                                    alt="">
                            </div>
                            <div class="carousel-container">
                                <div class="carousel-content">
        ...
        <section id="about">
            <div class="container">
                ...
                <header class="section-header">
                    <h3><?php echo e($content->getContent('anvs8c', 'title')); ?> <?php echo e(\App\Models\Setting::getValue('site_name')); ?>
        ...
        <section id="payments" class="wow fadeInUp">
            <div class="container">
                ...
                <div class="owl-carousel payments-carousel">
                    ...
                    <img src="<?php echo e(asset('front/img/payments/payment-interac.png')); ?>" alt="">
                    ...
                    <img src="<?php echo e(asset('front/img/payments/payment-bnb.png')); ?>" alt="">
                    <img src="<?php echo e(asset('front/img/payments/payment-tether.png')); ?>" alt="">
                    <img src="<?php echo e(asset('front/img/payments/payment-xrp.png')); ?>" alt="">
                    ...
                    <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a data-toggle="collapse" class="collapsed"
                                href="#faq<?php echo e($item->id); ?>"><?php echo e($item->question); ?> <i
        ...
        <section id="contact" class="section-bg wow fadeInUp">
            <div class="container">
                ...
                <div class="section-header">
                    ...
                    <p><?php echo $content->getContent('9sNF7G', 'description'); ?></p>
                ...
                <div class="row contact-info">
                    ...
                    <div class="col-md-4">
                        <div class="contact-address">
                            ...
                            <p><?php echo $content->getContent('52GPRA', 'description'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="contact-phone">
                            ...
                            <p><a href="tel: <?php echo e($content->getContent('0EXbji', 'description')); ?>">
                                    <?php echo $content->getContent('0EXbji', 'description'); ?></a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="contact-email">
                            ...
                            <p>
                                <a
                                    href="<?php echo e(\App\Models\Setting::getValue('contact_email')); ?>"><?php echo e(\App\Models\Setting::getValue('contact_email')); ?></a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="howtosteps-block d-flex">
                        <div
                            ...
                            <img data-src="<?php echo e(asset('front/img/about/icon_register.png')); ?>" alt="Register"
                                tilte="Register" src="<?php echo e(asset('front/img/about/icon_register.png')); ?>">
                            <h5>Register</h5>
                            <p>Sign up and upload your documents to verify your account.</p>
                        </div>
                        <div
                            class="col-md-3 col-sm-6 col-xs-12 item d-flex flex-column justify-content-center align-items-center text-center p-3">
                            <img data-src="<?php echo e(asset('front/img/about/ICONS_2-01.png')); ?>" alt="Fund" tilte="Fund"
                                src="<?php echo e(asset('front/img/about/ICONS_2-01.png')); ?>">
                            <h5>Fund</h5>
                            <p>Once you understand all the benefits and risks involved, you may fund your account.</p>
                        </div>
                        <div
                            class="col-md-3 col-sm-6 col-xs-12 item d-flex flex-column justify-content-center align-items-center text-center p-3">
                            <img data-src="<?php echo e(asset('front/img/about/ICONS_3-01.png')); ?>" alt="Trade" tilte="Trade"
                                src="<?php echo e(asset('front/img/about/ICONS_3-01.png')); ?>">
                            <h5>Trade</h5>
                            <p>Start trading on our WebTrader, Desktop or Mobile Platforms.</p>
                        </div>
                        <div
                            class="col-md-3 col-sm-6 col-xs-12 item d-flex flex-column justify-content-center align-items-center text-center p-3">
                            <img data-src="<?php echo e(asset('front/img/about/ICONS_4-01.png')); ?>" alt="Withdraw" tilte="Withdraw"
                                src="<?php echo e(asset('front/img/about/ICONS_4-01.png')); ?>">
                            <h5>Withdraw</h5>
