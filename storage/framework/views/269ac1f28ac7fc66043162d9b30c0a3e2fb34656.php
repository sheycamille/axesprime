...
<a class="mb-3 btn btn-primary" href="#" data-toggle="modal" data-target="#wmethodModal"><i class="fa fa-plus"></i> Add new</a> <br>
...
<form method="post" action="<?php echo e(route('updatesettings')); ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
       <select name="withdrawal_option" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>">
            <option value="<?php echo e(\App\Models\Setting::getValue('withdrawal_option')); ?>">Currently (<?php echo e(\App\Models\Setting::getValue('withdrawal_option')); ?>)</option>
    ...
    <div class="panel panel-default">
        ...
        <div class="sign-up2">
            <input type="text" name="bank_name" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('bank_name')); ?>">
        </div>
    </div>
    ...
    <div class="sign-u">
        ...
        <div class="sign-up2">
            <input type="text" name="account_name" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('account_name')); ?>">
        </div>
    ...
    <div class="sign-u">
        ...
        <div class="sign-up2">
            <input type="text" name="account_number" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('account_number')); ?>">
        </div>
    </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-up2">
            <input type="text" name="btc_address" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('btc_address')); ?>">
        </div>
    </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-up2">
            <input type="text" name="ltc_address" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('ltc_address')); ?>">
        </div>
    </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="eth_address" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('eth_address')); ?>">
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="s_s_k" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('s_s_k')); ?>">
            </div>
        </div>
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="s_p_k" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('s_p_k')); ?>">
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="pp_ci" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('pp_ci')); ?>">
            </div>
        </div>
        ...
        <div class="sign-u">
            ...
            <div class="sign-up2">
                <input type="text" name="pp_cs" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e(\App\Models\Setting::getValue('pp_cs')); ?>">
            </div>
        </div>
        </div>
    </div> <br> <br>
    ...
    <?php
        $pmodes = str_split(\App\Models\Setting::getValue('payment_mode'));
...
<div id="cpdModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                <form role="form" method="post" action="<?php echo e(route('updatecpd')); ?>">
                    ...
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <input type="submit" class="px-5 btn btn-primary btn-lg" value="Submit">
                </form>
            </div>
        </div>
    </div>
...
<!-- /set up coinpayments Modal -->
<?php /**PATH /Users/wadingaleonardngonga/Downloads/online-trade-06-04-2021/resources/views/admin/includes/payments.blade.php ENDPATH**/ ?>