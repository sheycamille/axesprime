                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <?php if(\App\Models\Setting::getValue('enable_kyc') == 'yes' && auth('admin')->user()->hasPermissionTo('mkyc-list', 'admin')): ?>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-start">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink"
                                                    style="z-index: 999;">
                                                    <?php if(auth('admin')->user()->hasPermissionTo('muser-access-wallet',
                                                    'admin')): ?>
                                                    <a class="m-1 btn btn-info btn-sm"
                                                        href="<?php echo e(route('userwallet', $user->id)); ?>">See
                                                        Wallet</a>
                                                    <?php endif; ?>
                                                    <?php if(auth('admin')->user()->hasPermissionTo('muser-block',
                                                    'admin')): ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php endif; ?>
                                                    <?php if(auth('admin')->user()->hasPermissionTo('muser-credit-debit',
                                                    'admin')): ?>
                                                    ...
                                                    <?php if(auth('admin')->user()->hasPermissionTo('muser-delete',
                                                    'admin')): ?>
                                                    <a href="#" data-toggle="modal"
                                                    ...
                                                    <?php if(auth('admin')->user()->hasPermissionTo('muser-messageall',
                                                    'admin')): ?>
                                                    <a href="#" data-toggle="modal"
                                                    ...
                                                    <?php if(auth('admin')->user()->hasPermissionTo('muser-access-account',
                                                    'admin')): ?>
                                                    <a href="#" data-toggle="modal"
